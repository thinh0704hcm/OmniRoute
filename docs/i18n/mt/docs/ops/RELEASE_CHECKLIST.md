...
> **Aġġornat l-aħħar:** 2026-08-28 — v3.8.51
> Fluss ta’ rilaxx issimplifikat li juża l-ħiliet ta’ Claude Code għall-awtomazzjoni.
>
> **Żomm il-kju/fergħa fi stat tajjeb bejn ir-rilaxxi:** ara [RELEASE_GREEN.md](./RELEASE_GREEN.md)
> (il-familja `/green-prs` + `npm run check:release-green` + `/babysit` + eżekuzzjoni ta’ billejl). It-tħaddim
> perjodiku ta’ dan — u speċjalment **qabel** din il-lista ta’ kontroll — jiżgura li l-PR tar-rilaxx jibda fi stat tajjeb.
