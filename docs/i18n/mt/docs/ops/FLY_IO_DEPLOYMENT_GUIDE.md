# OmniRoute Fly.io Deployment Guide (Malti)
...
Dan id-dokument jiddeskrivi l-proċess effettiv tal-iskjerament ta’ OmniRoute fuq Fly.io, u jkopri żewġ xenarji:

- L-iskjerament tal-proġett attwali fuq Fly.io għall-ewwel darba
- Il-pubblikazzjoni ta’ aġġornamenti sussegwenti tal-kodiċi
- Proġetti ġodda li jsegwu l-istess fluss tax-xogħol tal-iskjerament

Din il-gwida hija bbażata fuq konfigurazzjoni vverifikata u funzjonali għall-proġett attwali. L-isem tal-applikazzjoni huwa `omniroute`.
