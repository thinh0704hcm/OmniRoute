...
```
DevTools
→ Application (o Storage)
→ Cookies
```

Bagama't mukhang tama ang mga cookie na ito, maaaring ang mga ito ay:
...
→ Network
→ I-refresh ang page
→ Magbukas ng chat o conversation request
→ Request Headers
→ Cookie
```
...
5. Magbukas ng authenticated na chat o conversation request.
...
Nakadepende sa provider ang eksaktong mga credential na kinakailangan.
...
| ------------------------------- | ----------------------------- | -------------------------------- |
| Claude Web                      | Buong Cookie request header   | `docs/providers/CLAUDE_WEB.md`   |
| ChatGPT Web (Codex)             | Buong Cookie header           | `docs/providers/CHATGPT_WEB.md`  |
| Gemini Web                      | _(beripikahin)_               |                                  |
| Copilot Web                     | _(beripikahin)_               | `docs/providers/COPILOT-M365.md` |
