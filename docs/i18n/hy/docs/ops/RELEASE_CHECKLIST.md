...
>
> **Թողարկումների միջև հերթը/ճյուղը պահեք անխափան վիճակում՝** տե՛ս [RELEASE_GREEN.md](./RELEASE_GREEN.md)
> (`/green-prs` հրամանների ընտանիք + `npm run check:release-green` + `/babysit` + գիշերային գործարկում)։ Սա պարբերաբար, և հատկապես այս ստուգաթերթից **առաջ**, գործարկելը նպաստում է, որ թողարկման PR-ը սկզբից իսկ լինի անխափան վիճակում։
