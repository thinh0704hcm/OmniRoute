# OmniRoute Fly.io Deployment Guide (Latviešu)
...
Šajā dokumentā ir aprakstīts faktiskais OmniRoute izvietošanas process platformā Fly.io, aptverot trīs scenārijus:

- Pašreizējā projekta pirmreizēja izvietošana platformā Fly.io
- Turpmāko koda atjauninājumu publicēšana
- Jauni projekti, kas izmanto to pašu izvietošanas darbplūsmu

Šīs rokasgrāmatas pamatā ir pārbaudīta un darbspējīga pašreizējā projekta konfigurācija. Lietojumprogrammas nosaukums ir `omniroute`.
