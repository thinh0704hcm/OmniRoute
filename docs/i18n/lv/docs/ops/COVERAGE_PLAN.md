...
> Statuss noteikts 2026-05-13: rindas 82.58%, priekšraksti 82.58%, funkcijas 84.23%, zari 75.22%. 1.–5. posms ir pabeigts. Pašlaik uzmanība ir pievērsta 6. posmam (>=85%) un 7. posmam (>=90%).
