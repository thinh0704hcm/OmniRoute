...
> **Nuashonrú is déanaí:** 2026-08-28 — v3.8.51
> Sreabhadh eisiúna cuíchóirithe a bhaineann leas as scileanna Claude Code don uathoibriú.
>
> **Coinnigh an scuaine/an brainse glas idir eisiúintí:** féach [RELEASE_GREEN.md](./RELEASE_GREEN.md)
> (teaghlach `/green-prs` + `npm run check:release-green` + `/babysit` + rith oíche). Má ritear
> é seo go tréimhsiúil — agus go háirithe **roimh** an seicliosta seo — tosóidh an PR eisiúna glas.
