...
> **ბოლოს განახლდა:** 2026-08-28 — v3.8.51
> გამარტივებული გამოშვების პროცესი, რომელიც ავტომატიზაციისთვის Claude Code-ის უნარებს იყენებს.
>
> **გამოშვებებს შორის რიგისა და ბრენჩის გამართულობა შეინარჩუნეთ:** იხილეთ [RELEASE_GREEN.md](./RELEASE_GREEN.md)
> (`/green-prs` ოჯახი + `npm run check:release-green` + `/babysit` + ყოველღამეული შემოწმება). ამის პერიოდულად გაშვება — და განსაკუთრებით **ამ** საკონტროლო სიის შესრულებამდე — უზრუნველყოფს, რომ გამოშვების PR თავიდანვე გამართული იყოს.
