...
Sidecar များသည် TypeScript executor အတွင်းပိုင်း implementation များအပေါ် မှီခိုမည့်အစား JSON-safe provider plugin
manifest မှတစ်ဆင့် provider metadata ကို import လုပ်သင့်သည်။ Sidecar
အသုံးပြုခွင့်ဆိုင်ရာ သဘောတူညီချက်နှင့် migration အဆင့်များအတွက်
[Provider Plugin Manifest](./PROVIDER_PLUGIN_MANIFEST.md) ကို ကြည့်ပါ။
