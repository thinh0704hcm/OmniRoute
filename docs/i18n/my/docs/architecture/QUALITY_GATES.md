...
Script များသည် `scripts/check/` (မူဝါဒဂိတ်များ) နှင့် `scripts/quality/` (ratchet engine) အောက်တွင် ရှိသည်။
CI အတွက် တစ်ခုတည်းသော အမှန်တရားရင်းမြစ်မှာ `.github/workflows/ci.yml` ဖြစ်သည်။

### Release PR အမြန်လမ်းကြောင်း (`quality.yml`)

`.github/workflows/quality.yml` သည် `release/**` ကို ပစ်မှတ်ထားသော PR များတွင် လုပ်ဆောင်သည်။ ၎င်းသည် path-filter လုပ်ထားသော အမြန်ဂိတ်များနှင့်အတူ၊ code ပြောင်းလဲမှုများအတွက် အကြံပြုသဘောသက်သက်ဖြစ်သော production-build အချက်ပြမှုတစ်ခုကို ထည့်သွင်းပေးခြင်းဖြင့် contributor branch များကို ဆက်လက်တိုးတက်နိုင်စေသည်-

| Job                                              | အကျုံးဝင်မှု                                                                                                                                                                                                                                                               | ပိတ်ဆို့မှု                                                                                               |
| ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| `Build (advisory)`                               | Draft မဟုတ်သော code PR များနှင့် Mergify queue branch များ၊ Node 24၊ `npm-ci-retry`၊ `check:node-runtime`၊ `OMNIROUTE_USE_TURBOPACK=1` ဖြင့် `npm run build`၊ ၎င်းကို အသုံးပြုမည့် downstream quality job မရှိသောကြောင့် artifact တင်ခြင်းမရှိ                             | **အကြံပြုချက်သာ** (`continue-on-error: true`; release-PR run များ တစ်ပတ်ကြာ တည်ငြိမ်ပြီးနောက် ဖယ်ရှားရန်) |
| `Docs Gates (fast-path)`                         | Docs/code PR များ၊ API docs reference များနှင့် docs-all                                                                                                                                                                                                                   | ဟုတ်သည်                                                                                                   |
| `Fast Quality Gates`                             | Code PR များ၊ static စစ်ဆေးမှုများ၊ typecheck၊ dashboard typecheck၊ သက်ရောက်မှုရှိသော unit test များ                                                                                                                                                                       | ဟုတ်သည်                                                                                                   |
| `Forgotten sibling tests`                        | Code PR များ၊ ပြောင်းလဲထားသော module များမှ static consumer များနှင့် ဖြစ်နိုင်ခြေရှိသော sibling test များသို့ ခြေရာခံခြင်း၊ barrel နှင့် dynamic-import path များကို အကြံပြုသဘော diagnostic များအဖြစ် အစီရင်ခံပြီး ပြန်လည်သုံးသပ်ထားသော allowlist ခြွင်းချက်များ ပါဝင်သည် | **အကြံပြုချက်သာ**                                                                                         |
| `Vitest (fast-path)`                             | Code PR များ၊ အမြန် vitest suite                                                                                                                                                                                                                                           | ဟုတ်သည်                                                                                                   |
| `Unit Tests fast-path`                           | Code PR များ၊ shard 4 ခုပါသော unit suite                                                                                                                                                                                                                                   | ဟုတ်သည်                                                                                                   |
| `No new ESLint warnings`                         | Code PR များ၊ suppression များကို ထည့်သွင်းစဉ်းစားသော lint guard                                                                                                                                                                                                           | ကိုယ်ပိုင် origin အတွက် ဟုတ်သည်၊ fork များအတွက် အကြံပြုချက်သာ                                             |
| `Merge integrity (changelog + generated skills)` | Draft မဟုတ်သော PR များ၊ changelog နှင့် ထုတ်လုပ်ထားသော skill များကို sync လုပ်ခြင်း                                                                                                                                                                                        | ကိုယ်ပိုင် origin အတွက် ဟုတ်သည်၊ fork များအတွက် အကြံပြုချက်သာ                                             |

#### မေ့လျော့နေသော sibling test များ၏ အစီရင်ခံစာ

`npm run check:forgotten-sibling-tests` သည် test-impact map နောက်ကွယ်ရှိ import resolver ကို ပြန်လည်အသုံးပြုသည်။
ပြောင်းလဲထားသော production module တစ်ခုစီအတွက် ဖြစ်နိုင်ခြေရှိသော test သည် pull-request diff တွင် မပါဝင်ပါက၊ ဆုံးဖြတ်ချက်တူညီစွာ ထွက်ပေါ်စေသော
`changed module/symbol -> static consumer -> candidate sibling test` chain များကို အစီရင်ခံသည်။ ပိတ်ဆို့မှု စတင်အသုံးမပြုမီ ချိန်ညှိရန်အတွက် Markdown အနှစ်ချုပ်နှင့် JSON ရလဒ်ကို
`forgotten-sibling-tests` workflow artifact အဖြစ် ထိန်းသိမ်းထားသည်။

Barrel re-export များနှင့် dynamic import များသည် resolution diagnostic များသာဖြစ်ပြီး ပိတ်ဆို့သည့် finding တစ်ခုကို ဘယ်သောအခါမှ မဖန်တီးပါ။ ပြန်လည်သုံးသပ်ထားသော ခြွင်းချက်များကို
`config/quality/forgotten-sibling-allowlist.json` တွင် ထားရှိသည်။ Entry တစ်ခုစီသည် consumer နှင့် ဖြစ်နိုင်ခြေရှိသော
test ကို အမည်တပ်ရမည်၊ တိကျသော အကြောင်းပြချက်ပေးရမည်၊ ထို့အပြင် GitHub issue သို့မဟုတ် pull request တစ်ခုသို့ link ချိတ်ရမည်။ ပုံစံမမှန်သော entry များသည်
အလိုအလျောက် ပိတ်ဆို့သည်။ ခြွင်းချက်များသည် ဖျက်လိုက်သော candidate test သို့မဟုတ် `.skip`/`.todo` ထည့်သွင်းထားသော diff ကို မဖုံးကွယ်နိုင်ပါ။
Assertion အားလျော့စေခြင်းနှင့် အခြား masking များကို သီးခြားပိတ်ဆို့ထားသော
`check:test-masking` ဂိတ်က ဆက်လက်တာဝန်ယူသည်။

### Job: `lint`

`main` သို့ ဦးတည်သော PR တိုင်းတွင် လုပ်ဆောင်သည်။ မအောင်မြင်ပါက merge လုပ်ခြင်းကို ပိတ်ဆို့သည်။

| Script (`npm run ...`)            | စစ်ဆေးအတည်ပြုသည့်အရာ                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | ပိတ်ဆို့မှုရှိခြင်း                           |
| --------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- |
...
| `check:route-validation:t06`      | route အားလုံးတွင် Zod schema များ ပါရှိသည် (Tier 6 မူဝါဒ)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | ရှိသည်                                        |
| `check:any-budget:t11`            | `@ts-expect-error // any` အရေအတွက်သည် သတ်မှတ်အများဆုံးပမာဏကို မကျော်လွန်ပါ (Tier 11 catraca)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | ရှိသည်                                        |
| `check:provider-consistency`      | `providers.ts` ရှိ provider တိုင်းတွင် `providerRegistry.ts` ထဲ၌ ကိုက်ညီသော entry တစ်ခုရှိပြီး အပြန်အလှန်အားဖြင့်လည်း allowlist အတွင်း ကိုက်ညီမှုရှိသည်                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | ဟုတ်သည်                                       |
| `check:model-lifecycle`           | ကိုယ်တိုင်ထိန်းသိမ်းထားသော routing table သုံးခုသည် repository တွင် ထည့်သွင်းထားသည့် lifecycle snapshot (#11503) နှင့် တစ်သမတ်တည်းရှိနေသည်- `FITNESS_TABLE` (`taskFitness.ts`) သည် `REGISTRY` က route လုပ်နိုင်သော အနားပေးပြီး id တစ်ခုကိုမျှ score မပေးပါ၊ `BUILT_IN_ALIASES` target တိုင်းသည် `REGISTRY` တွင်ရှိပြီး အနားပေးပြီး id snapshot တွင် မရှိပါ၊ `REGISTRY` ထဲတွင် ရှိနေသေးသော အနားပေးပြီး id တိုင်းကို forward လုပ်ထားသည် သို့မဟုတ် `allowedRetiredInCatalog` တွင် စာရင်းသွင်းထားသည်၊ ထို့ပြင် `DEFAULT_DEGRADATION_MAP` ၏ source သို့မဟုတ် target တစ်ခုမျှ ထို snapshot တွင် အနားပေးပြီးအဖြစ် မပေါ်ပါ။ ၎င်းက model တစ်ခုကို လက်ရှိတွင် အသက်ဝင်နေသော upstream က ဝန်ဆောင်မှုပေးနေကြောင်း သက်သေမပြပါ။ Offline — `config/quality/model-lifecycle.json` နှင့် နှိုင်းယှဉ်ပြီး `npm run quality:refresh-model-lifecycle` (ကွန်ရက်လိုအပ်သည်၊ CI နှင့် မချိတ်ဆက်ထားပါ) ဖြင့် ကိုယ်တိုင် refresh လုပ်ထားသည်။ `allowedRetiredInCatalog` သည် တဖြည်းဖြည်းလျှော့ချရန်သုံးသော ratchet ဖြစ်သည်- tracking issue တစ်ခုရှိမှသာ entry တစ်ခု ထည့်ပါ။ | ဟုတ်သည်                                       |
| `check:fetch-targets`             | client-side `src/` ရှိ `fetch("/api/...")` တိုင်းသည် အမှန်တကယ်ရှိသော `route.ts` တစ်ခုသို့ resolve ဖြစ်သည်                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | ဟုတ်သည်                                       |
| `check:deps`                      | repo ထဲရှိ `package.json` တိုင်းမှ `npm install` လုပ်နိုင်သော dependency အားလုံးသည် `dependency-allowlist.json` တွင် ပါဝင်သည်၊ အသစ်ထည့်ထားသော version ပုံသေမသတ်မှတ်ထားသည့် package သို့မဟုတ် slopsquatting ဖြစ်နိုင်သော package များကို အမှတ်အသားပြုသည်                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | ဟုတ်သည်                                       |
| `audit:deps`                      | `npm audit` (ပင်မ + electron) — high/critical advisory မရှိပါ (osv `check:vuln-ratchet` နှင့် ထပ်နေသည်၊ Rationalization Backlog ကို ကြည့်ပါ)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | ဟုတ်သည်                                       |
| `check:lockfile`                  | `package-lock.json` ၏ integrity — https registry၊ integrity hash များ၊ host override မရှိခြင်း                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | ဟုတ်သည်                                       |
| `check:licenses`                  | ထုတ်လုပ်ရေး dependency များအတွက် SPDX license ခွင့်ပြုစာရင်း                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | ဟုတ်သည်                                       |
| `check:tracked-artifacts`         | build artifact များ / commit လုပ်ထားသော `node_modules` symlink များ မရှိရပါ (husky pre-commit တွင်လည်း လုပ်ဆောင်သည်၊ pre-push ကို ရည်ရွယ်ချက်ရှိရှိ ပေါ့ပါးစွာထားသည် — #6716)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | ဟုတ်သည်                                       |
| `check:vitest-exclusions`         | Vitest exclusion တိုင်းတွင် tracking issue တစ်ခုကို ဖော်ပြထားပြီး `config/quality/vitest-exclusions.json` တွင် ပါရှိရမည် (#13204)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | ဟုတ်သည်                                       |
| `check:file-size`                 | source file တစ်ခုမျှ extension အလိုက် သတ်မှတ်ထားသော အများဆုံးပမာဏကို မကျော်လွန်ရပါ (ratchet: ကြီးမားသော file များကို `frozen` စာရင်းတွင် အတည်ပြုထားသည်)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | ဟုတ်သည်                                       |
| `check:error-helper`              | executor/handler များရှိ error response များတွင် `buildErrorBody()` / `sanitizeErrorMessage()` ကို အသုံးပြုရမည် (မဖြစ်မနေလိုက်နာရမည့် စည်းမျဉ်း #12)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | ဟုတ်သည်                                       |
| `check:migration-numbering`       | Migration SQL file များကို အစဉ်လိုက် နံပါတ်တပ်ထားရမည်ဖြစ်ပြီး နံပါတ်လွတ်ခြင်း သို့မဟုတ် ထပ်နေခြင်း မရှိရပါ                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | ဟုတ်သည်                                       |
| `check:public-creds`              | `publicCreds.ts` ပြင်ပတွင် တိုက်ရိုက်ရေးသားထားသော OAuth `client_id`/`client_secret` သို့မဟုတ် Firebase Web keys မရှိရ (တင်းကျပ်သော စည်းမျဉ်း #11)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | ဟုတ်သည်                                       |
| `check:db-rules`                  | `src/lib/db/` modules များ၏ ပြင်ပတွင် raw SQL မရှိရ၊ `localDb.ts` မှ barrel-imports မလုပ်ရ (တင်းကျပ်သော စည်းမျဉ်းများ #2/#5)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | ဟုတ်သည်                                       |
| `check:known-symbols`             | ၎င်းတို့၏ dispatch tables များတွင် မှတ်ပုံတင်ထားသော provider executors၊ routing strategies နှင့် translators များသည် disk ပေါ်ရှိ files များနှင့် ကိုက်ညီရမည် — အဆက်အစပ်မရှိသော သို့မဟုတ် ကြေညာမထားသော symbols မရှိရ                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | ဟုတ်သည်                                       |
| `check:route-guard-membership`    | child process တစ်ခုကို စတင်သည့် route တိုင်းကို `isLocalOnlyPath()` ဖြင့် အမျိုးအစားခွဲထားရမည် (တင်းကျပ်သော စည်းမျဉ်းများ #15/#17)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | ဟုတ်သည်                                       |
| `check:test-discovery`            | repo အတွင်းရှိ `*.test.ts` / `*.spec.ts` file တိုင်းကို အနည်းဆုံး test runner တစ်ခုက စုဆောင်းရမည် (ratchet: `test-discovery-baseline.json` အတွင်းရှိ orphan list သည် လျော့နည်းရန်သာ ခွင့်ပြုသည်)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | ဟုတ်သည်                                       |
| `check:agent-skills-sync`         | ထုတ်လုပ်ထားသော agent-skills artifacts များသည် ၎င်းတို့၏ မူရင်း catalog နှင့် ကိုက်ညီရမည် (ကွဲလွဲမှုမရှိရ)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `check:provider-asset-provenance` | Provider logos/assets များတွင် မှတ်တမ်းတင်ထားသော provenance entry တစ်ခု ပါရှိရမည်                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `lint:json`                       | JSON config ဖိုင်များကို parse လုပ်နိုင်ပြီး repo ၏ lint စည်းမျဉ်းများနှင့် ကိုက်ညီကြောင်း စစ်ဆေးသည်                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `typecheck:core`                  | အမှားများမရှိဘဲ TypeScript compilation ပြုလုပ်သည် (အကြံပြုသတိပေးချက်များသာ)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | ဟုတ်သည်                                       |
| `typecheck:noimplicit:core`       | တင်းကျပ်သော `noImplicitAny` — အနာဂတ်ကို ရည်ရွယ်ထားသည်။ ယခင်ကတည်းက ရှိနေသော call site အများအပြားတွင် annotation များ ထည့်ရန် လိုအပ်နေသေးသည်                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | **အကြံပြုချက်သာ** (`continue-on-error: true`) |
| `check:dashboard-typecheck`       | `src/app/(dashboard)/**` (#7033) ကိုသာ အကျုံးဝင်သည့် `tsc` — `typecheck:core` ၏ စိစစ်ရွေးချယ်ထားသော ဖိုင် 27 ခုပါ allowlist တွင် dashboard TSX တစ်ခုမျှ မပါဝင်သကဲ့သို့ `next build` ကလည်း ၎င်းကို type-check လုံးဝ မလုပ်ပါ (`next.config.mjs` တွင် `ignoreBuildErrors: true` သတ်မှတ်ထားသည်)။ ထို့ကြောင့် ထိုနေရာရှိ orphaned-identifier regression များ (#6625/#6909) ကို CI က မမြင်နိုင်ခဲ့ပါ။ မပြောင်းလဲစေရန် သတ်မှတ်ထားသော ဖိုင်အလိုက်/TS-code အလိုက် အရေအတွက် baseline (`config/quality/dashboard-typecheck-baseline.json`၊ `check:known-symbols` နှင့် တူညီသော stale-enforcement ပုံစံ) ကို အခြေခံ၍ diff ပြုလုပ်သည် — baseline သတ်မှတ်ထားသော အရေအတွက်ထက် ကျော်လွန်သည့် အမှားအသစ်များသာ gate ကို မအောင်မြင်စေသည်။ ယခင်ရှိပြီးသား အမှားတစ်ခုကို ပြင်ဆင်ပြီးသည့်အခါ `--update` ဖြင့် baseline ကို လျှော့ချပါ။                                                                                                                                                                                                                              | ဟုတ်သည်                                       |

### အလုပ်: `quality-gate`

`test-coverage` ပြီးနောက် လုပ်ဆောင်သည်။ မအောင်မြင်ပါက merge လုပ်ခြင်းကို ပိတ်ဆို့သည်။

| Script                       | စစ်ဆေးအတည်ပြုသည့်အရာ                                                                                                                                                                                                                            | ပိတ်ဆို့မှု                  |
| ---------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- |
| `quality:collect`            | `quality-metrics.json` ကို ထုတ်ပေးသည် (ESLint သတိပေးချက်အရေအတွက်၊ ပေါင်းစည်းထားသော shard report မှ coverage)                                                                                                                                    | ဟုတ်သည် (ratchet ၏ upstream) |
| `quality:ratchet`            | `quality-baseline.json` ရှိ metric တစ်ခုစီ ဆုတ်ယုတ်မှုမရှိကြောင်း စစ်ဆေးသည် (ESLint သတိပေးချက်များ ≤ baseline၊ coverage ≥ baseline)                                                                                                             | ဟုတ်သည်                      |
| `check:duplication`          | Code duplication (jscpd@4) သည် `quality-baseline.json` ရှိ baseline ထက် မကျော်လွန်ကြောင်း စစ်ဆေးသည်                                                                                                                                             | ဟုတ်သည်                      |
| `check:complexity`           | ဖိုင်အဆင့် cyclomatic complexity သည် သတ်မှတ်အများဆုံးပမာဏကို မကျော်လွန်ကြောင်း စစ်ဆေးသည် (core ESLint `complexity` + `max-lines-per-function`)                                                                                                  | ဟုတ်သည်                      |
| `check:cognitive-complexity` | Cognitive complexity ratchet (`eslint-plugin-sonarjs`) — သီးခြား ESLint pass ဖြစ်သည်။ CI တွင် နှစ်ခုစလုံးကို `check:complexity-ratchets` အဆင့်တစ်ခုတည်းအဖြစ် ပေါင်းစည်း၍ လုပ်ဆောင်သည်                                                           | ဟုတ်သည်                      |
| `check:dead-code`            | အသုံးမပြုသော export / ဖိုင် ratchet (knip) သည် baseline နှင့် နှိုင်းယှဉ်လျှင် ဆုတ်ယုတ်မှုမရှိကြောင်း စစ်ဆေးသည်                                                                                                                                 | ဟုတ်သည်                      |
| `check:compression-budget`   | Compression benchmark budget — engine တစ်ခုချင်းစီအတွက် token-savings အနိမ့်ဆုံးသတ်မှတ်ချက်များ မဆုတ်ယုတ်ရပါ                                                                                                                                    | ဟုတ်သည်                      |
| `check:type-coverage`        | Percent-typed ratchet (`type-coverage`) သည် မဆုတ်ယုတ်ရပါ။ `typecheck:noimplicit:core` ကို အများအားဖြင့် လွှမ်းခြုံအစားထိုးထားသည်                                                                                                                | ဟုတ်သည်                      |
| `check:codeql-ratchet`       | ဖွင့်ထားသော CodeQL alert အရေအတွက် မတိုးပွားကြောင်း စစ်ဆေးသည် (`gh api` မှတစ်ဆင့် ဖတ်သည်။ token မရှိပါက အမှားမဖြစ်စေဘဲ ကျော်သွားသည်) — refresh လုပ်သည့် ကြိမ်နှုန်းနှင့် ကိုယ်တိုင် trigger လုပ်ခြင်းအတွက် အောက်ရှိ "CodeQL ratchet" ကို ကြည့်ပါ | ဟုတ်သည်                      |

### အလုပ်: `quality-extended`

Job တစ်ခုလုံးသည် အကြံပြုချက်ပေးရန်သာဖြစ်သည် (`continue-on-error: true`)။ npm အခြေပြု ratchet များကို
အမှန်တကယ် လုပ်ဆောင်သည်။ ပြင်ပ scanner များကို `gh release download` မှတစ်ဆင့် ထည့်သွင်းပြီး binary
မရှိသေးသည့်အခါ အလိုအလျောက် ကျော်သွားသည် (exit 0)။

| Script                   | စစ်ဆေးအတည်ပြုသည့်အရာ                                                                                                                                                                                   | ပိတ်ဆို့မှု       |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------- |
| `check:circular-deps`    | Circular dependency မရှိခြင်း (dpdm)                                                                                                                                                                   | **အကြံပြုချက်သာ** |
| `check:bundle-size`      | Bundle အရွယ်အစားသည် သတ်မှတ်အများဆုံးပမာဏထက် မကျော်လွန်ခြင်း                                                                                                                                            | **အကြံပြုချက်သာ** |
| `check:secrets`          | Secret scanning (gitleaks) — binary မရှိပါက ကျော်သွားသည်                                                                                                                                               | **အကြံပြုချက်သာ** |
| `check:vuln-ratchet`     | Dependency အားနည်းချက်များ (osv-scanner) ပိုမိုဆိုးရွားမလာခြင်း — binary မရှိပါက ကျော်သွားသည်                                                                                                          | **အကြံပြုချက်သာ** |
| `check:workflows`        | Workflow lint (actionlint + zizmor) — binary များမရှိပါက ကျော်သွားသည်                                                                                                                                  | **အကြံပြုချက်သာ** |
| `check:openapi-breaking` | Public API contract (`openapi.yaml`) နှင့် base branch ကြားရှိ breaking change များ (oasdiff) — `openapiBreaking=N` ကို ထုတ်ပေးသည်။ oasdiff မရှိပါက သို့မဟုတ် base spec ကို ဖြေရှင်းမရပါက ကျော်သွားသည် | **အကြံပြုချက်သာ** |

### Job: `docs-sync-strict`

`main` သို့ PR ပြုလုပ်တိုင်း လုပ်ဆောင်သည်။ မအောင်မြင်ပါက merge လုပ်ခြင်းကို ပိတ်ဆို့သည်။
...
| ↳ `check:docs-counts`          | ရှင်းလင်းချက်စာသားရှိ အရေအတွက်များ (provider အရေအတွက်၊ migration အရေအတွက် စသည်) သည် အမှန်တကယ်အရေအတွက်များ၏ ratchet window အတွင်း ရှိခြင်း                                                                                     | ဟုတ်သည်                                |
...
| ↳ `check:deprecated-versions`  | Docs များတွင် deprecated version string မရှိခြင်း                                                                                                                                                                             | ဟုတ်သည်                                |
| ↳ `check:doc-links`            | Docs များရှိ internal markdown link များသည် တကယ်ရှိသော file များသို့ ရောက်ရှိခြင်း (`[text]`/`(path)` ပုံစံ)                                                                                                                  | ဟုတ်သည်                                |
| ↳ `check:fabricated-docs`      | Docs များတွင် ဖော်ပြထားသော route များ၊ env var များ၊ CLI command များ၊ hook အမည်များနှင့် file path များသည် codebase ထဲတွင် တကယ်ရှိခြင်း။ `--strict` မှတစ်ဆင့် hard gate အဖြစ် ဆောင်ရွက်ပြီး flag မပါလျှင် soft-fail ဖြစ်သည်။ | ဟုတ်သည် (CI တွင် `--strict` မှတစ်ဆင့်) |
| `check:cli-i18n`               | CLI command string များသည် i18n locale file အားလုံးတွင် ပါရှိခြင်း                                                                                                                                                            | ဟုတ်သည်                                |
| `check:openapi-coverage`       | OpenAPI spec သည် တကယ်ရှိသော route များ၏ ratchet ဖြင့် သတ်မှတ်ထားသည့် အနည်းဆုံးအဆင့်ကို ပြည့်မီစွာ လွှမ်းခြုံခြင်း                                                                                                             | ဟုတ်သည်                                |
| `check:openapi-security-tiers` | `openapi.yaml` ရှိ security tier annotation များသည် `routeGuard.ts` classification များနှင့် တစ်သမတ်တည်းဖြစ်ခြင်း                                                                                                             | **အကြံပြုချက်သာ**                      |
| `check:openapi-routes`         | `openapi.yaml` ရှိ path တိုင်းသည် တကယ်ရှိသော `route.ts` သို့ ရောက်ရှိခြင်း (ဖန်တီးမှန်းဆမှု ဆန့်ကျင်ကာကွယ်ရေး)                                                                                                                | ဟုတ်သည်                                |
| `check:docs-symbols`           | `docs/**/*.md` ရှိ `/api/...` ကိုးကားချက်တိုင်းသည် တကယ်ရှိသော `route.ts` သို့ ရောက်ရှိခြင်း (ဖန်တီးမှန်းဆမှု ဆန့်ကျင်ကာကွယ်ရေး)                                                                                               | ဟုတ်သည်                                |
| `i18n translation drift`       | i18n locale file များရှိ ဘာသာမပြန်ရသေးသော key များ — သတိပေးချက်သာ                                                                                                                                                             | **အကြံပြုချက်သာ**                      |

### Job: `i18n-ui-coverage`

| Script                            | စစ်ဆေးအတည်ပြုသည့်အရာ                                                                                                                                                                                                                  | ပိတ်ဆို့မှု       |
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `check-ui-keys-coverage` (inline) | UI i18n key လွှမ်းခြုံမှုသည် ≥ 65% ဖြစ်သည်                                                                                                                                                                                            | ရှိသည်            |
| `check-ui-value-drift` (inline)   | ပြန်လည်ရေးသားထားသော အင်္ဂလိပ် **value** တစ်ခုသည် ခေတ်မမီတော့သော ဘာသာပြန်ချက်ကို ကျန်ရစ်စေခြင်းမရှိပါ                                                                                                                                  | ရှိသည်            |
| `check-new-key-coverage` (inline) | **အသစ်** ထည့်ထားသော အင်္ဂလိပ် key ကို locale တိုင်းတွင် ဘာသာပြန်ထားသည် — `__MISSING__:` marker ကို လက်မခံပါ                                                                                                                           | ရှိသည်            |
| `check-translation-ratio`         | locale တစ်ခုချင်းစီအလိုက် အမှန်တကယ် ဘာသာပြန်ထားမှုအချိုး (allowlist ပြင်ပရှိ အင်္ဂလိပ်နှင့် ထပ်တူဖြစ်သော / placeholder ဖြစ်သော / ပျောက်ဆုံးနေသော leaf များ) သည် `config/quality/i18n-translation-baseline.json` + slack ထက် မကျော်ရပါ | **အကြံပြုချက်သာ** |

`fetch-depth: 0` လိုအပ်သည် — value-drift gate သည် merge base နှင့် `en.json` တို့၏ diff ကို စစ်ဆေးသည်။

#### `check-ui-value-drift` — ခေတ်မမီသော ဘာသာပြန်ချက် gate

အခြား gate များက ဖွဲ့စည်းပုံအရ ရှာမတွေ့နိုင်သော i18n regression တစ်မျိုးကို ဖမ်းယူသည်။ အင်္ဂလိပ် value ကို
ပြန်လည်ရေးသားလိုက်သော်လည်း _ယခင်_ အင်္ဂလိပ်မှ ဆင်းသက်လာသော ဘာသာပြန်ချက်များက ကျန်ရစ်နေသဖြင့်
အင်္ဂလိပ်မဟုတ်သော ဘာသာစကားသုံးစွဲသူများသည် ယုံကြည်စိတ်ချရသည့်ပုံစံဖြင့် ရေးသားထားသော်လည်း ယခုအခါ မှားယွင်းနေသော စာသားကို ဆက်လက်ဖတ်ရှုနေရသည်။

ဤပြဿနာသည် အမှန်တကယ် production သို့ ရောက်ရှိခဲ့သည်။ Antigravity
login helper ထည့်သွင်းစဉ် (#5203) `oauthModal.googleOAuthWarning` ကို ပြန်လည်ရေးသားခဲ့သော်လည်း **locale 43 ခုအနက် 39 ခုတွင်**
operator များအား "URL အပြည့်အစုံကို ကူးယူပြီး အောက်တွင် paste လုပ်ပါ" ဟု ပြောထားသည့် စာသား ဆက်လက်ကျန်ရှိခဲ့သည် — ထို provider အတွက်
ပြီးဆုံးအောင် လုပ်ဆောင်၍မရသော flow ဖြစ်သည်။ အောက်ပါအကြောင်းများကြောင့် #8463 မတိုင်မီအထိ
သတိမပြုမိခဲ့ပါ။

- `sync-ui-keys` သည် **မရှိသေးသော** key များကိုသာ backfill လုပ်ပြီး **ခေတ်မမီတော့သော** key များကို ဘယ်တော့မှ မလုပ်ပါ။
- `check-ui-keys-coverage` သည် key _ရှိနေမှု_ ကို ရေတွက်သဖြင့် ခေတ်မမီသော ဘာသာပြန်ချက်ကို လွှမ်းခြုံထားသည်ဟု သတ်မှတ်သည်။
- `check-translation-drift` သည် `docs/i18n/<locale>/**.md` documentation mirror များကို ခြေရာခံသည် —
  `src/i18n/messages/*.json` ကို လုံးဝမဖတ်ပါ။ 2026-09 re-sync မှစ၍ job `docs-sync-strict` တွင် ပိတ်ဆို့ထားသည်။
  core doc တစ်ခုကို တည်းဖြတ်ပါ → `npm run i18n:run -- --files=<doc>` (section အဆင့်သာဖြစ်၍ ကုန်ကျစရိတ်နည်းသည်)။

**Diff ကို သိရှိအသုံးပြုပြီး baseline ကို အခြေခံခြင်းမဟုတ်ပါ။** ၎င်းသည် merge base ရှိ `en.json` ကို
working tree နှင့် နှိုင်းယှဉ်သည်။ အင်္ဂလိပ် value ပြောင်းလဲထားသော key တစ်ခုချင်းစီအတွက် locale တစ်ခုခုတွင်
မပြောင်းလဲထားသော ဘာသာပြန်ချက် ဆက်လက်ရှိနေပါက ၎င်းသည် ခေတ်မမီတော့ပါ။ ဤနည်းလမ်းသည် **ယခင်ရှိပြီးသား အကြွေးကို တမင်တကာ ခဲထားသည်** —
diff တစ်ခုက ကာလရှည်ကြာရှိနေသော ဘာသာပြန်ချက်သည် မည်သည့် အင်္ဂလိပ်အဟောင်းမှ ဆင်းသက်လာကြောင်း မဖော်ပြနိုင်သဖြင့် gate သည်
လက်ရှိပြောင်းလဲမှုက ထိတွေ့သည့်အရာများကိုသာ ဆုံးဖြတ်သည်။ အခြားရွေးချယ်စရာဖြစ်သော key တစ်ခုချင်းစီအလိုက် hash baseline သည်
~600 KB ရှိသော generated file တစ်ခု လိုအပ်မည်ဖြစ်ပြီး လက်ရှိအကြီးဆုံး baseline ထက် 3× ကြီးကာ i18n PR တိုင်းတွင် မကြာခဏ ပြောင်းလဲနေမည်ဖြစ်သည်။

၎င်းကို ဖြည့်ဆည်းရန် နည်းလမ်းနှစ်ခုရှိသည်။

1. သက်ရောက်မှုရှိသော ဘာသာပြန်ချက်များကို အပ်ဒိတ်လုပ်ပါ၊ သို့မဟုတ်
2. ၎င်းတို့ကို `__MISSING__:<new english>` ဟု သတ်မှတ်ပါ — ထို့နောက် runtime သည် ပြင်ဆင်ပြီးသော အင်္ဂလိပ်စာသားကို ပေးပို့ပြီး
   (`src/i18n/request.ts::deepMergeFallback`, #7258) ထို key ကို ဘာသာပြန်ရန် queue ထဲ ထည့်ပေးသည်။

စာကြောင်း၏ **အဓိပ္ပာယ်** ပြောင်းလဲသွားပါက **key ကို အမည်ပြောင်းခြင်း** ကို ဦးစားပေးပါ။ key အသစ်တစ်ခုသည်
ခေတ်မမီသော ဘာသာပြန်ချက်ကို ဆက်ခံ၍မရပါ။ #8463 တွင် ဤပုံစံကို အသုံးပြုခဲ့သည်။

```bash
npm run i18n:check-value-drift          # တင်းကျပ်သောစစ်ဆေးမှု (CI က လုပ်ဆောင်သည့်အရာ)
npm run i18n:check-value-drift:warn     # အစီရင်ခံရုံသာ
BASE_REF=origin/release/vX.Y.Z npm run i18n:check-value-drift
```

base catalog ကို ဖတ်၍မရသည့်အခါ (base ref မပါသော shallow
clone) `check-openapi-breaking` နှင့် အလားတူစွာ `SKIP reason=base-unresolved` ဖြင့် 0 အဖြစ် ထွက်သည်။

### Job: `i18n`

i18n validation matrix အပြည့်အစုံ (locale တစ်ခုလျှင် job တစ်ခု)။ job တစ်ခုလုံးသည် အကြံပြုချက်သဘောသာ ဖြစ်သည်။

| Script                          | စစ်ဆေးအတည်ပြုသည့်အရာ                                   | ပိတ်ဆို့မှု                                                     |
| ------------------------------- | ------------------------------------------------------ | --------------------------------------------------------------- |
| `validate_translation.py quick` | locale တစ်ခုချင်းစီအလိုက် ဘာသာပြန်ဆိုမှု ပြည့်စုံခြင်း | **အကြံပြုချက်သာ** (job တစ်ခုလုံးတွင် `continue-on-error: true`) |

### Job: `pr-test-policy`

pull request များတွင်သာ လုပ်ဆောင်သည်။

| Script                 | စစ်ဆေးအတည်ပြုသည့်အရာ                                                                                                                                                                    | ပိတ်ဆို့မှု |
| ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `check:pr-test-policy` | `src/`, `open-sse/`, `electron/` သို့မဟုတ် `bin/` ရှိ production code ကို ပြောင်းလဲသော PR များတွင် test များ ထည့်သွင်းရမည် သို့မဟုတ် အပ်ဒိတ်လုပ်ရမည် (Hard Rule #8)                     | ရှိသည်      |
| `check:test-masking`   | ပြောင်းလဲထားသော test file များသည် စုစုပေါင်း assert အရေအတွက်ကို မလျှော့ချဘဲ `assert.ok(true)` tautology များကိုလည်း မထည့်ပါ                                                             | ရှိသည်      |
| `check:pr-evidence`    | PR body တွင် ပြောင်းလဲမှုအတွက် test/VPS အထောက်အထားကို ကိုးကားထားသည် (PR စာသားကို grep လုပ်ခြင်းဖြင့် Hard Rule #18 ကို အလိုအလျောက်စစ်ဆေးသည် — ပျက်စီးလွယ်သောကြောင့် Backlog ကိုကြည့်ပါ) | ရှိသည်      |

### Job: `test-vitest`

`build` ပြီးနောက် လုပ်ဆောင်သည်။ မအောင်မြင်ပါက merge ကို ပိတ်ဆို့သည်။

| စမ်းသပ်မှုအစု    | စစ်ဆေးအတည်ပြုသည့်အရာများ                                   | ပိတ်ဆို့မှု                                                                                                                                                            |
| ---------------- | ---------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `test:vitest`    | MCP ဆာဗာ (ကိရိယာ 110 ခု)၊ autoCombo၊ cache — vitest runner | ရှိ                                                                                                                                                                    |
| `test:vitest:ui` | UI အစိတ်အပိုင်း စမ်းသပ်မှုများ — vitest runner             | **ပိတ်ဆို့မှုရှိ** — ယခင်ရှိပြီးသား မအောင်မြင်မှုများကို `vitest.config.ts` တွင် အတိအလင်း ဖယ်ထုတ်ထားသည်။ အသစ်ဖြစ်ပေါ်သော မအောင်မြင်မှုများသည် အလုပ်ကို မအောင်မြင်စေသည် |

### ညစဉ် အလုပ်အသွားအလာများ (အချိန်ဇယားဖြင့် လုပ်ဆောင်ပြီး အကြံပြုချက်သဘောသာဖြစ်သည်)

၎င်းတို့ကို cron အချိန်ဇယား (နှင့် `workflow_dispatch`) ဖြင့် လုပ်ဆောင်ပြီး PR များတွင် မည်သည့်အခါမျှ မလုပ်ဆောင်ပါ။ အားလုံးသည် အကြံပြုချက်သဘောသာဖြစ်သည်။

| အလုပ်အသွားအလာ          | စစ်ဆေးအတည်ပြုသည့်အရာများ                                                                                                                                                                               | ပိတ်ဆို့မှု           |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- |
| `nightly-property`     | ကျပန်း seed နှင့် မြင့်မားသော run အရေအတွက်ကို အသုံးပြုသည့် fast-check property စမ်းသပ်မှုများ                                                                                                          | **အကြံပြုချက်သဘောသာ** |
| `nightly-resilience`   | heap တိုးပွားမှု gate၊ chaos fault-injection၊ k6 load/soak                                                                                                                                             | **အကြံပြုချက်သဘောသာ** |
| `nightly-llm-security` | promptfoo injection guard (block mode) + garak probes (provider secret မရှိပါက ကျော်သွားမည်)                                                                                                           | **အကြံပြုချက်သဘောသာ** |
| `nightly-schemathesis` | `docs/openapi.yaml` ကို အသုံးပြု၍ လည်ပတ်နေသော OmniRoute တစ်ခုကို ဆန့်ကျင်သည့် OpenAPI contract fuzzing (schemathesis) — spec ချိုးဖောက်မှုများ / ကိုင်တွယ်မထားသော 500 များကို ဖော်ထုတ်သည် (Fase 8 B.4) | **အကြံပြုချက်သဘောသာ** |
| `nightly-mutation`     | မြန်ဆန်သော unit lane ပေါ်ရှိ Stryker mutation-testing ရမှတ် — ဆက်လက်ကျန်ရှိသော mutants များက အားနည်းသည့် asserts များကို ဖော်ထုတ်သည်                                                                   | **အကြံပြုချက်သဘောသာ** |
| `nightly-compat`       | ပံ့ပိုးထားသော `engines.node` အပိုင်းအခြားများတစ်လျှောက် Node engine လိုက်ဖက်ညီမှု matrix                                                                                                               | **အကြံပြုချက်သဘောသာ** |
...
- ထောက်ပံ့ရေးကွင်းဆက် (မူလရင်းမြစ်၊ SBOM၊ Trivy၊ Scorecard): [`docs/security/SUPPLY_CHAIN.md`](../security/SUPPLY_CHAIN.md)

#### `check-key-completeness` — key-set တူညီမှု စစ်ဆေးဂိတ်

`scripts/i18n/check-key-completeness.mjs` (`npm run i18n:check-keys`၊ job `i18n-ui-coverage`)။
`src/i18n/messages/<locale>.json` တစ်ခုချင်းစီ၏ leaf key set ကို `en.json` နှင့် နှိုင်းယှဉ်ပြီး
key ကို မည်သည့်အချိန်တွင် ထည့်ခဲ့သည်ဖြစ်စေ ပျောက်နေသော သို့မဟုတ် အပို leaf တစ်ခုခုရှိလျှင်
မအောင်မြင်ပါ။ `__MISSING__:` placeholder များကို ရှိနေသည်ဟု မှတ်ယူသည် (၎င်းတို့၏ အကြောင်းအရာသည်
ratio gate က ကိုင်တွယ်ရမည့်ကိစ္စဖြစ်သည်)။ ၎င်းသည် diff အခြေခံ/ရာခိုင်နှုန်းအခြေခံ gate နှစ်ခု၏
အပြည့်အဝ ဖြည့်ဖက်ဖြစ်သည်။ `check-ui-keys-coverage` သည် locale တစ်ခုစီအတွက် အနည်းဆုံး 80 %
သတ်မှတ်ထားသည် (`~13,000` ထဲမှ key 43 ခု ပျောက်နေသော်လည်း 99.7 % ဟု ဖတ်ရဆဲဖြစ်သည်)၊
`check-new-key-coverage` ကမူ PR တစ်ခုက `en.json` သို့ ထည့်သည့် key များကိုသာ ဆုံးဖြတ်သည်။
locale batch တစ်ခုကို ၎င်း၏ branch ဖြတ်သည့်နေ့ရှိ `en.json` မှ ထုတ်လုပ်ပြီး base တွင် key များ
ဆက်လက်ထည့်နေစဉ် ရက်ပေါင်းများစွာ ဘာသာပြန်သည်။ batch PR ကိုယ်တိုင်က key မထည့်သဖြင့်
batch 1 (#13044) သည် locale ကိုးခုတွင် key 43 ခု လျော့နေသောအခြေအနေဖြင့် ပေါင်းစည်းသွားချိန်နှင့်
batch 2 (#13660) သည် locale ရှစ်ခုတွင် key 10 ခု လျော့နေသောအခြေအနေဖြင့် ပေါင်းစည်းသွားချိန်
(2026-09-15) တို့တွင် sibling gate နှစ်ခုစလုံးက သတိပေးခြင်းမရှိခဲ့ပါ။ အနီရောင် မအောင်မြင်မှုကို
`node scripts/i18n/sync-ui-keys.mjs --locale=<codes> --translate-markers` ဖြင့် ပြင်ဆင်ပါ။
`extra` leaf ဆိုသည်မှာ source က ၎င်းကို ဖယ်ရှားလိုက်ပြီဟု ဆိုလိုသည် — locale မှလည်း ဖျက်ပါ။
`--warn` သည် မအောင်မြင်စေဘဲ အစီရင်ခံသည်။
`--catalog=cli` သည် `bin/cli/locales` ပေါ်တွင် အလားတူ နှိုင်းယှဉ်မှုကို လုပ်ဆောင်သည်
(`npm run i18n:check-keys:cli`)။ အဆင့်နှစ်ခုစလုံးသည် job `i18n-ui-coverage` တွင် ရှိသည်။

#### `check-new-key-coverage` — key အသစ် i18n စစ်ဆေးဂိတ်

`check-ui-value-drift` ၏ sibling ဖြစ်သည်။ ထို gate က အင်္ဂလိပ် value ကို **ပြန်လည်ရေးသား**
ထားသော်လည်း ၎င်း၏ ဘာသာပြန်များ မပြောင်းဘဲ ကျန်နေခြင်းကို ဖမ်းယူပြီး၊ ဤ gate က အင်္ဂလိပ် key ကို
**အသစ်ထည့်ထား** သော်လည်း အချို့ locale များတွင် ၎င်းကို လုံးဝ မရရှိခြင်းကို ဖမ်းယူသည်။

`check-ui-keys-coverage` သည် ဤအခြေအနေအမျိုးအစားကို မမြင်နိုင်ပါ။ ၎င်းသည် locale တစ်ခုစီအလိုက်
ရာခိုင်နှုန်း အနည်းဆုံးတန်ဖိုးကို သတ်မှတ်ထားပြီး `~13,000` ထဲမှ key ဆယ့်တစ်ခု ပျောက်နေသော်လည်း
coverage မှာ 99.9% ရှိနေသည်။ ဘာသာစကားတစ်ခုစီအလိုက် ရာခိုင်နှုန်းသည် "ဤ feature ကို
ဘာသာမပြန်ဘဲ ဖြန့်ချိခဲ့သည်" ဟူသောအခြေအနေကို မဖော်ပြနိုင်ပါ — feature တစ်ခုလုံးသည် locale အသစ်တစ်ခုတွင်
စာသားမပါဘဲ ရောက်ရှိနိုင်ပြီး ကိန်းဂဏန်းကို လုံးဝ မပြောင်းလဲစေနိုင်ပါ။

၎င်းက မှတ်တမ်းတင်ထားသော ဖြစ်ရပ်မှာ Orchestration Canvas ၏ Phase 3 က ထိုအချိန်တွင် ရှိခဲ့သော
locale 42 ခုလုံး၌ ၎င်း၏ key ဆယ့်တစ်ခုကို ဘာသာပြန်ခဲ့ခြင်းဖြစ်သည်။ နာရီအနည်းငယ်အကြာတွင်
EU-language batch (#13044) က repo ကို locale 51 ခုအထိ တိုးသွားစေခဲ့ပြီး အသစ်ရောက်လာသည့်
ကိုးခု (`el`, `et`, `ga`, `hr`, `lt`, `lv`, `mt`, `sl`, `sr`) သည် ၎င်းတို့ကို လုံးဝ မရရှိခဲ့ပါ။
`deepMergeFallback` သည် ပျောက်နေသော key အတွက် အင်္ဂလိပ်စာဖြင့် အစားထိုးသဖြင့် မအောင်မြင်သည့်
ပုံစံမှာ UI အလွတ်ဖြစ်ခြင်းထက် ဘာသာမပြန်ထားသော UI ဖြစ်ခဲ့သည် — အမှန်တကယ် ဖြစ်ပေါ်ခဲ့ပြီး
ဒီဇိုင်းအရ အသံတိတ်နေခဲ့သည်။

၎င်း၏ sibling ကဲ့သို့ပင် ဤ gate သည် **diff-aware** ဖြစ်ပြီး merge base ရှိ အင်္ဂလိပ်စာကို
working tree နှင့် နှိုင်းယှဉ်သောကြောင့် ယခင်ကတည်းက ရှိနေသော ကွာဟချက်များကို မပြောင်းဘဲ
ထိန်းထားနိုင်ပြီး gate ကို ဖွင့်ရန် migration မလိုအပ်ခဲ့ပါ။

**`__MISSING__:<english>` marker တစ်ခုသည် လိုအပ်ချက်ကို မပြည့်မီပါ (2026-09-17 မှစ၍)။**
ယခင်က ၎င်းသည် မှတ်တမ်းတင်ထားသော ရွှေ့ဆိုင်းနည်းဖြစ်ခဲ့သည် — runtime က မှန်ကန်သော
အင်္ဂလိပ်စာသို့ fallback လုပ်ပေးသည် — သို့သော် 2026-09-16 တွင် feature PR ရှစ်ခုက key 61 ခု
ထည့်ခဲ့ပြီး ဘာသာပြန်မည့်အစား locale 65 ခုလုံးတွင် marker ကို ထည့်ခဲ့သည်။ ဤ gate က အားလုံးကို
လက်ခံခဲ့ပြီး PR များကို မည်သည့်အရာကမျှ မပိတ်ပင်ခဲ့သလို blocking real-translation ratio gate က
နောက်ဆုံးတွင် release tip ပေါ်၌ လူတိုင်းအတွက် မအောင်မြင်ခဲ့သည် (pt-BR 3.2 % > 2.5 % + 0.5)။
ယခုအခါ marker တစ်ခုကို ပျောက်နေသော ဘာသာပြန်တစ်ခုအဖြစ် သတ်မှတ်သည်။ အနီရောင် မအောင်မြင်မှုကို
`node scripts/i18n/sync-ui-keys.mjs --locale=<codes> --translate-markers --batch-size=40` ဖြင့်
ပြင်ဆင်ပါ၊ သို့မဟုတ် locale အားလုံးအတွက် `npm run i18n:translate-new-keys`
(`scripts/i18n/translate-new-keys.sh`၊ detached-safe ဖြစ်ပြီး `OMNIROUTE_TRANSLATION_*` env
မရှိဘဲ စတင်ရန် ငြင်းပယ်သည်) ဖြင့် တစ်ပြိုင်နက် လုပ်ဆောင်ပါ။ အင်္ဂလိပ်အတိုင်းသာ ထားရမည့် key
တစ်ခု (သတ်မှတ်ထားသော product/engine/flag အမည်) ကို `scripts/i18n/untranslatable-keys.json`
တွင် ထည့်ရမည်ဖြစ်ပြီး marker နောက်ကွယ်တွင် မထားရပါ။ `vi` သည် marker များကို လုံးဝ တားမြစ်သည်
(`tests/unit/i18n-vi-completeness.test.ts`)။

#### `check-vitest-exclusions` — ဆိုင်းငံ့ထားသော test စစ်ဆေးဂိတ်

`vitest.config.ts` ၏ `exclude` စာရင်းထဲရှိ file တစ်ခုသည် အမှန်တကယ် မလုပ်ဆောင်သော test
တစ်ခုဖြစ်သော်လည်း tree ကို ဖတ်သူအတွက် coverage ရှိသည့်ပုံ ပေါ်စေသည်။ file ခြောက်ဆယ့်နှစ်ခုသည်
`// #8618 — ယခင်ကတည်းက ရှိနေသော မအောင်မြင်မှု၊ ပြင်ဆင်ပြီးသောအခါ ဤ exclusion ကို ဖယ်ရှားပါ` ဟူသော comment နောက်ကွယ်တွင်
စုပုံလာခဲ့သည်။ Issue #8618 ကို 2026-08-11 တွင် ပိတ်ခဲ့သော်လည်း ၎င်းက ခြေရာခံခဲ့သည့် စာရင်းသည်
entry 45 ခုမှ 62 ခုအထိ တိုးလာခဲ့ပြီး အသစ်ထည့်သမျှတိုင်းက ပိတ်ပြီးသား issue တစ်ခုကို ညွှန်းသည့်
comment ကို ဆက်ခံခဲ့သည်။ နောက်ဆုံးတွင် စာရင်းကို file တစ်ခုချင်းစီ တိုင်းတာခဲ့ချိန် (#13204) တွင်
**62 ခုထဲမှ 51 ခုသည် source ကို လုံးဝ မပြောင်းဘဲ လက်ရှိ tree နှင့် စမ်းသပ်ရာတွင် အောင်မြင်ခဲ့သည်**။

ဤ gate သည် တကယ်ရှိသော file တစ်ခုသို့ resolve ဖြစ်သည့် exclusion တိုင်းကို (a) tracking issue
တစ်ခု အမည်ပေးရန်နှင့် (b) ၎င်း၏ တိုင်းတာထားသော status နှင့်အတူ
`config/quality/vitest-exclusions.json` တွင် ပါဝင်ရန် လိုအပ်သည်။ ထို့ကြောင့် exclusion တစ်ခု
ထည့်ခြင်းသည် entry 60 ပါ array တစ်ခုထဲသို့ နောက်ထပ် စာကြောင်းတစ်ကြောင်း ထည့်ခြင်းမဟုတ်ဘဲ
သီးခြား file တစ်ခုအတွင်း review လုပ်နိုင်သော diff တစ်ခု ဖြစ်လာသည်။ ၎င်းသည် ဖယ်ထုတ်ထားသော
test များကို ရည်ရွယ်ချက်ရှိရှိ ပြန်မလုပ်ဆောင်ပါ — ထိုသို့လုပ်ရန် ~10 မိနစ် ကုန်ကျပြီး periodic job
တစ်ခုတွင်သာ လုပ်သင့်သည်။ inventory က တစ်ခုချင်းစီကို နောက်ဆုံးတိုင်းတာခဲ့သည့်အချိန်ကို
မှတ်တမ်းတင်ထားသည်။
