...
npm run check:cli-i18n          # cuando cambien las cadenas o los catálogos de la CLI
npm run lint
```
...
npm run build:cli             # cambios en la CLI generada/empaquetada
npm run check:pack-policy     # cambios en la superficie del paquete
npm run lint
```
