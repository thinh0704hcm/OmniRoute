...
| Gemini Web                      | _(tekshirish kerak)_            |                                  |
| Copilot Web                     | _(tekshirish kerak)_            | `docs/providers/COPILOT-M365.md` |
| Microsoft 365 Copilot (BizChat) | WS access_token + chathubPath   | `docs/providers/COPILOT-M365.md` |
| Grok Web                        | _(tekshirish kerak)_            |                                  |
| ...                             | ...                             | ...                              |
