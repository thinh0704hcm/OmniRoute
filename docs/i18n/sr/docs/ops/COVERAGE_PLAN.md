...
> Статус измерен 2026-05-13: линије 82.58%, наредбе 82.58%, функције 84.23%, гране 75.22%. Фазе 1-5 су завршене. Тренутни фокус је на фази 6 (>=85%) и фази 7 (>=90%).
