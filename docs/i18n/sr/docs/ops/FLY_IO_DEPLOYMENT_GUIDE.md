# OmniRoute Fly.io Deployment Guide (Српски)
...
Овај документ описује стварни процес примене OmniRoute-а на Fly.io, обухватајући два сценарија:

- Прву примену тренутног пројекта на Fly.io
- Објављивање накнадних ажурирања кода
- Нове пројекте који прате исти ток примене

Овај водич је заснован на провереној функционалној конфигурацији тренутног пројекта. Назив апликације је `omniroute`.
