...
| মেয়াদোত্তীর্ণ / বিদেশি / পরিবর্তিত সেশন JWT           | 401, CLI পুনরায় এক্সচেঞ্জ করে                       |
| এক্সচেঞ্জের পরে OmniRoute API কী প্রত্যাহার করা হয়েছে | পরবর্তী RPC-তে 401                                   |
| কোনো সক্রিয় `cursor-api` সংযোগ নেই                    | 503 `unavailable`                                    |
| Cursor সংযোগের কী প্রত্যাখ্যান করে                     | 401 `unauthenticated`, ক্যাশ করা সেশন বাদ দেওয়া হয় |
| আপস্ট্রিমে পৌঁছানো যায় না                             | 502 `unavailable` (পরিশোধিত বার্তা)                  |
| `JWT_SECRET` সেট করা নেই                               | এক্সচেঞ্জে 503                                       |
