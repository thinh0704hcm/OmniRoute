...
npm run build:cli             # promjene generiranog/pakiranog CLI-ja
...
npm run check:lockfile         # promjene ovisnosti ili datoteke zaključavanja
