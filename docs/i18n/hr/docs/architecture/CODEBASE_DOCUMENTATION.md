...
Istaknuto (potpuni popis nalazi se u `open-sse/services/`):
...
| Skupne obrade             | `batchProcessor.ts`                                                                                                                                                                                                                                      |
| Upotreba                  | `usage.ts`                                                                                                                                                                                                                                               |
...
pomoćne funkcije za vjerodajnice (`credentialLoader.ts`, `codexClient.ts`) i adapteri
