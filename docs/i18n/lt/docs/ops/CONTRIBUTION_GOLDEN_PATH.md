...
npm run build:cli             # sugeneruoto / sujungto CLI pakeitimai
npm run check:pack-policy     # paketo viešosios sąsajos pakeitimai
npm run lint
```
