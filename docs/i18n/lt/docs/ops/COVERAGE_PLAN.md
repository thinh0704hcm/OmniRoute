...
> Būsena įvertinta 2026-05-13: eilutės 82.58%, teiginiai 82.58%, funkcijos 84.23%, šakos 75.22%. 1–5 etapai baigti. Šiuo metu daugiausia dėmesio skiriama 6 etapui (>=85%) ir 7 etapui (>=90%).
