...
| **ACP Agents** | `/dashboard/acp-agents` | CLI avviate da OmniRoute come backend tramite stdio/ACP (flusso inverso)                  | vedi registro |

Le route legacy eseguono un reindirizzamento 308: `/dashboard/cli-tools` → `/dashboard/cli-code`, `/dashboard/agents` → `/dashboard/acp-agents`.
