...
### 4. Устанавливайте квоты для каждого ключа
...
### 5. Проверяйте крупнейших потребителей
...
- [ENVIRONMENT.md](../reference/ENVIRONMENT.md#18-pricing-sync) — переменные окружения для синхронизации цен
- [AUTO-COMBO.md](../routing/AUTO-COMBO.md) — как `auto/fast` и `auto/cheap` снижают затраты
- [API_REFERENCE.md](../reference/API_REFERENCE.md) — полное справочное руководство по `/api/usage/*`
