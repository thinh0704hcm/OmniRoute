...
## Ingyenes szolgáltatók csatlakoztatása

### 1. lépés: Nyissa meg az irányítópultot

Nyissa meg a `http://localhost:20128` címet a böngészőjében.
...
## Hogyan teszi jobbá az OmniRoute az ingyenes csomagokat?

### 1. Automatikus tartalékra váltás

Ha egy ingyenes szolgáltató túlterhelt vagy nem működik, az OmniRoute automatikusan megpróbálja a következőt. Önnek semmit sem kell tennie.

### 2. Intelligens útválasztás

Az OmniRoute minden kéréshez kiválasztja a **legjobb ingyenes szolgáltatót** a következők alapján:

- Sebesség — Melyik szolgáltató a leggyorsabb jelenleg?
- Minőség — Melyik szolgáltató a legjobb ehhez a feladathoz?
- Kapacitás — Melyik szolgáltatónál maradt még kvóta?

### 3. Tokenmegtakarítás

Az OmniRoute tömörítési folyamata csökkentheti a megfelelő promptok és eszközkimenetek tokenszámát. A
tényleges megtakarítás a tartalomtól, a kiválasztott motoroktól, a szolgáltató elszámolási módjától és a tartalomhűségi
beállításoktól függ; a tömörítés nem sokszorozza meg rögzített mértékben az egyes szolgáltatók kvótáját.

### 4. Több fiók támogatása

Ha a szolgáltató feltételei több fiókot vagy hitelesítési adatot is engedélyeznek, az OmniRoute minden
kapcsolatot külön útválasztási jelöltként kezelhet. Ne hozzon létre további fiókokat a szolgáltató
kvótájának vagy hozzáférési szabályzatának megkerülésére.
...
A katalógus a szolgáltatók által közzétett feltételeket és a projekt kutatási eredményeit rögzíti, az ajánlatok azonban változhatnak.
Használat előtt ellenőrizze a szolgáltató aktuális díjszabását, kvótáját, adatvédelmi szabályzatát és jogosultsági feltételeit.

### „Elfogyhat az ingyenes keret?”

Bármely szolgáltató alkalmazhat sebességkorlátozást, módosíthatja a modelleket, felfüggesztheti a hozzáférést vagy leállhat. Több
kapcsolat javítja a tartalék útvonalak lefedettségét, de nem garantálja, hogy mindig rendelkezésre áll ingyenes útvonal.

### „Használhatok ingyenes szolgáltatókat éles környezetben?”

Csak akkor, ha a szolgáltató SLA-ja, adatkezelése, korlátai és feltételei megfelelnek az éles környezetre vonatkozó
követelményeinek. A kritikus munkaterhelésekhez felügyelt, szerződéses szempontból megfelelő tartalék megoldást kell biztosítani.

### „Mi a hátulütője?”

A kompromisszumok közé tartozhatnak a szigorú korlátok, várólisták, KYC, bankkártyás ellenőrzés, a promptok
betanítási célú felhasználása, gyengébb adatvédelem, az SLA hiánya, a modellek gyakori cseréje, földrajzi korlátozások, fizetős kerettúllépés vagy
a fiókszabályzatból eredő kockázatok. Az OmniRoute megjeleníti az elérhető metaadatokat; Ön dönti el, mit engedélyez.

### „Hogyan szerezhetek több ingyenes kvótát?”

1. Csatlakoztasson több ingyenes szolgáltatót
2. Engedélyezze a megfelelő tömörítési motorokat, és mérje meg a megtakarítást a saját munkaterhelésén
3. Használja az `auto/cheap` beállítást az ingyenes/olcsó szolgáltatók előnyben részesítéséhez
4. Adjon hozzá további engedélyezett szolgáltatókat vagy hitelesítő adatokat anélkül, hogy megsértené a szolgáltatók feltételeit

### „Az ingyenes szolgáltatók rosszabb minőséget kínálnak?”

Nem feltétlenül. Egyes szolgáltatók ugyanazokat a modellcsaládokat teszik elérhetővé, mint a fizetős
útvonalak, de a korlátok, a késleltetés, az adatvédelem, a megbízhatóság és a modellverziók eltérhetnek. Használja
az Ingyenes szolgáltatók rangsora oldalt minőségi jelzésként, és ellenőrizze a ténylegesen kiszolgált modellt.

---

## Mi a következő lépés?

- **[Automatikus kombináció útmutató](./AUTO-COMBO-GUIDE.md)** — Hagyja, hogy az OmniRoute válassza ki Önnek a legjobb MI-t
- **[Szolgáltatói útmutató](./PROVIDERS-GUIDE.md)** — Csatlakoztasson további szolgáltatókat
- **[Hibaelhárítás](../guides/TROUBLESHOOTING.md)** — Gyakori problémák megoldása
- **[Ingyenes csomagok referenciája](../reference/FREE_TIERS.md)** — Az ingyenes csomagok teljes listája
