...
[Caveman](https://github.com/JuliusBrussee/caveman) ଦ୍ୱାରା ଅନୁପ୍ରାଣିତ — ଅର୍ଥ ସଂରକ୍ଷଣ କରି filler ଶବ୍ଦ ଏବଂ ଅତି-ବିସ୍ତୃତ ବାକ୍ୟାଂଶକୁ ଅପସାରଣ କରେ:
...
- **Structural Integrity Guards** — `tool_use` + `tool_result` ଯୋଡ଼ିଗୁଡ଼ିକ ସୁସଙ୍ଗତ ରହିବା ସୁନିଶ୍ଚିତ କରେ
...
- `git status`, `git diff`, `git log`, test runner,
  TypeScript/Vite/Webpack build, ESLint/Biome/Prettier, npm audit/install, Docker log, infra
  output ଏବଂ generic shell output ଭଳି command/output class ଚିହ୍ନଟ କରେ
...
OmniRoute ଦୁଇଟି ଉତ୍ସରୁ ମିଳୁଥିବା କମ୍ପ୍ରେସନ୍ ସଞ୍ଚୟକୁ ଡକ୍ୟୁମେଣ୍ଟ କରେ: ଅପ୍ଷ୍ଟ୍ରିମ୍ ପ୍ରକଳ୍ପ ବେଞ୍ଚମାର୍କ ଏବଂ
OmniRoute ର ନିଜସ୍ୱ ଇଞ୍ଜିନ୍ ସଂଯୋଜନ।
...
ଏହା ଆଶାକରାଯାଇଥିବା ସୁରକ୍ଷିତ ଆଚରଣ, କୌଣସି ବଗ୍ ନୁହେଁ: ମୁଖ୍ୟତଃ ସ୍ୱଚ୍ଛ ଫାଇଲ୍ଗୁଡ଼ିକୁ ପଢ଼ୁଥିବା/grep କରୁଥିବା ଏକ କୋଡିଂ ସେସନ୍ରେ
କମ୍ପ୍ରେସନ୍ ସମ୍ପୂର୍ଣ୍ଣ ସକ୍ଷମ ଥିଲେ ମଧ୍ୟ ସାମାନ୍ୟ ସମୁଦାୟ ସଞ୍ଚୟ ଦେଖାଯିବ, ଯେତେବେଳେ ଏକ ବିଫଳ
ଲୁପ୍ କିମ୍ବା ଅତ୍ୟଧିକ ଆଉଟ୍ପୁଟ୍ ଦେଉଥିବା ଲିଣ୍ଟର୍ର ସମ୍ମୁଖୀନ ହେଉଥିବା ସେସନ୍ରେ ସେହି ଟ୍ରାଫିକ୍ ଉପରେ ସମ୍ପୂର୍ଣ୍ଣ 78-95% ପରିସର ଦେଖାଯିବ। କମ୍ ସମଗ୍ର ସଞ୍ଚୟ
ପ୍ରତିଶତ ଥିବା ଗୋଟିଏ ସେସନ୍କୁ କମ୍ପ୍ରେସନ୍ ଭୁଲ ଭାବେ କନ୍ଫିଗର୍ ହୋଇଥିବାର ପ୍ରମାଣ ଭାବେ ବ୍ୟବହାର କରନ୍ତୁ ନାହିଁ — ପ୍ରଥମେ ଯାଞ୍ଚ କରନ୍ତୁ ଯେ
ଅନ୍ତର୍ନିହିତ ଟୁଲ୍ ଆଉଟ୍ପୁଟ୍ ପ୍ରକୃତରେ ପୁନରାବୃତ୍ତ ଥିଲା କି ନାହିଁ।
...
`Dashboard → Context & Cache`କୁ ଯାଆନ୍ତୁ:
...
`Dashboard → Context & Cache → Compression Combos`ରେ, ଏକ ରାଉଟିଂ କମ୍ବୋକୁ ଏକ ସଙ୍କୋଚନ କମ୍ବୋ ନ୍ୟସ୍ତ କରନ୍ତୁ:
...
ଏହି "ପ୍ରତି-କମ୍ବୋ ଓଭରରାଇଡ୍" ଆସାଇନ୍ମେଣ୍ଟଟି **ରାଉଟିଂ-କମ୍ବୋ ସଙ୍କୋଚନ ମୋଡ୍** ଓଭରରାଇଡ୍ (Default/Off/Lite/Standard/Aggressive/Ultra)ଠାରୁ ଏକ ଭିନ୍ନ ନିୟନ୍ତ୍ରଣ — ସେହି ଓଭରରାଇଡ୍ କୌଣସି ନାମିତ ସଙ୍କୋଚନ-କମ୍ବୋ ପାଇପ୍ଲାଇନ୍ ବାଛେ ନାହିଁ; ଏହା କେବଳ `resolveCompressionPlan` ଦ୍ୱାରା ଯାଞ୍ଚ କରାଯାଉଥିବା `compressionMode` ଫିଲ୍ଡକୁ ସେଟ୍ କରେ। ଏହାକୁ କମ୍ବୋ କାର୍ଡରେ (`Dashboard → Combos`) କିମ୍ବା #6760 ପରଠାରୁ, ଉପରେ ଡକ୍ୟୁମେଣ୍ଟ କରାଯାଇଥିବା ପାଇପ୍ଲାଇନ୍-ଆସାଇନ୍ମେଣ୍ଟ ଚେକ୍ବକ୍ସର ଠିକ୍ ପାଖରେ ଥିବା `Dashboard → Context & Cache → Compression Combos`ର "Assign to routing" ତାଲିକାରେ ପ୍ରତ୍ୟେକ ରାଉଟିଂ କମ୍ବୋ ପାଇଁ ସେଟ୍ କରାଯାଇପାରିବ। ଉଭୟ ଇଣ୍ଟରଫେସ୍ ସମାନ `PUT /api/combos/{id}` ଏଣ୍ଡପଏଣ୍ଟ ମାଧ୍ୟମରେ ସ୍ଥାୟୀ ଭାବେ ସଂରକ୍ଷିତ ହୁଏ।
...
କୌଣସି ବିଷୟ ସ୍ଥାୟୀ ଭାବେ ସଂରକ୍ଷିତ ହେବା ପୂର୍ବରୁ RTK raw-output recovery ସାଧାରଣ API କୀ, bearer ଟୋକନ୍, Slack ଟୋକନ୍, AWS ଆକ୍ସେସ୍ କୀ,
ପାସୱାର୍ଡ, ଟୋକନ୍ ଏବଂ ସିକ୍ରେଟ୍ଗୁଡ଼ିକୁ ଲୁଚାଇଦିଏ।
...
Standard ମୋଡ୍ କମ୍ପ୍ରେସନ୍ ନିୟମଗୁଡ଼ିକ **[JuliusBrussee](https://github.com/JuliusBrussee)**ଙ୍କ **[Caveman](https://github.com/JuliusBrussee/caveman)** (⭐ 51K+) — ଭାଇରାଲ୍ "ଅଳ୍ପ ଟୋକନ୍ରେ କାମ ହେଉଥିବାବେଳେ ଅଧିକ ଟୋକନ୍ କାହିଁକି ବ୍ୟବହାର କରିବେ" ପ୍ରକଳ୍ପ — ଦ୍ୱାରା ଅନୁପ୍ରାଣିତ। Caveman `~75%` କମ୍ ଆଉଟ୍ପୁଟ୍ ଟୋକନ୍, ବେଞ୍ଚମାର୍କରେ ହାରାହାରି `65%` ଆଉଟ୍ପୁଟ୍ ସଞ୍ଚୟ, `22-87%` ଆଉଟ୍ପୁଟ୍ ପରିସର ଏବଂ ଏକ `~46%` ଇନ୍ପୁଟ୍-କମ୍ପ୍ରେସନ୍ ଟୁଲ୍ ରିପୋର୍ଟ କରେ।

RTK ମୋଡ୍ **[RTK AI](https://github.com/rtk-ai)**ଙ୍କ **[RTK - Rust Token Killer](https://github.com/rtk-ai/rtk)** — ଟର୍ମିନାଲ୍, ବିଲ୍ଡ, ଟେଷ୍ଟ, git ଏବଂ ଟୁଲ୍-ଆଉଟ୍ପୁଟ୍ ଫିଲ୍ଟରିଂ ପାଇଁ ଉଚ୍ଚ-କାର୍ଯ୍ୟଦକ୍ଷତାସମ୍ପନ୍ନ କମାଣ୍ଡ-ଆଉଟ୍ପୁଟ୍ କମ୍ପ୍ରେସନ୍ ପ୍ରକଳ୍ପ — ଦ୍ୱାରା ଅନୁପ୍ରାଣିତ। RTK `60-90%` ସଞ୍ଚୟ ରିପୋର୍ଟ କରେ, ଏବଂ ଏହାର README ନମୁନା ସେସନ୍ରେ `~80%` ସଞ୍ଚୟ ଦେଖାଯାଇଛି।

---

## ଉନ୍ନତ କମ୍ପ୍ରେସନ୍ ସିଷ୍ଟମ୍ଗୁଡ଼ିକ

7ଟି ମାନକ ମୋଡ୍ ବ୍ୟତୀତ, OmniRoute ରେ ଅନେକ ଉନ୍ନତ କମ୍ପ୍ରେସନ୍
ସିଷ୍ଟମ୍ ଅନ୍ତର୍ଭୁକ୍ତ ଅଛି, ଯାହା କଣ୍ଟେକ୍ସ୍ଟ ଆଧାରରେ ସ୍ୱୟଂଚାଳିତ ଭାବେ କାମ କରେ।

### କ୍ୟାଶ୍-ସଚେତନ କମ୍ପ୍ରେସନ୍

କିଛି ପ୍ରଦାନକାରୀ (ଯେପରିକି ପ୍ରମ୍ପ୍ଟ କ୍ୟାଶିଂ ସହିତ Anthropic) **ପ୍ରମ୍ପ୍ଟ କ୍ୟାଶିଂ** ସମର୍ଥନ କରନ୍ତି,
ଯାହା ସେମାନଙ୍କୁ ଖର୍ଚ୍ଚ ଏବଂ ବିଳମ୍ବତା କମାଇବା ପାଇଁ ପ୍ରମ୍ପ୍ଟର କିଛି ଅଂଶ କ୍ୟାଶ୍ କରିବାକୁ ଦିଏ। ଯେତେବେଳେ
କ୍ୟାଶିଂ ସକ୍ଷମ ଥାଏ, aggressive କମ୍ପ୍ରେସନ୍ ପ୍ରକୃତରେ କାର୍ଯ୍ୟଦକ୍ଷତାକୁ **କ୍ଷତି** ପହଞ୍ଚାଇପାରେ,
କାରଣ ଏହା କ୍ୟାଶ୍ ହୋଇଥିବା ଟୋକନ୍ଗୁଡ଼ିକୁ ପରିବର୍ତ୍ତନ କରି କ୍ୟାଶ୍କୁ ଅବୈଧ କରିଦିଏ।
...
1. **କ୍ୟାଶିଂ କଣ୍ଟେକ୍ସ୍ଟ ଚିହ୍ନଟ କରନ୍ତୁ** — `cache_control` ମାର୍କର୍ଗୁଡ଼ିକ ପାଇଁ ଅନୁରୋଧ ବଡିକୁ ସ୍କାନ୍ କରେ
2. **କ୍ୟାଶିଂ ପ୍ରଦାନକାରୀଙ୍କୁ ଚିହ୍ନଟ କରନ୍ତୁ** — ଲକ୍ଷ୍ୟ ପ୍ରଦାନକାରୀ କ୍ୟାଶିଂ ସମର୍ଥନ କରନ୍ତି କି ନାହିଁ ଯାଞ୍ଚ କରେ
3. **କୌଶଳ ସମନ୍ୱୟ କରନ୍ତୁ** — କ୍ୟାଶିଂ ପ୍ରଦାନକାରୀଙ୍କ ପାଇଁ `aggressive`/`ultra`କୁ `standard`କୁ ଡାଉନ୍ଗ୍ରେଡ୍ କରେ
...
କ୍ୟାଶ୍-ସଚେତନ କମ୍ପ୍ରେସନ୍ **ସର୍ବଦା ସକ୍ରିୟ** — କୌଣସି କନ୍ଫିଗରେସନ୍ ଆବଶ୍ୟକ ନାହିଁ। ଏହା କେବଳ ନିମ୍ନ ପରିସ୍ଥିତିରେ
ସକ୍ରିୟ ହୁଏ:
...
| ମୋର ADHD ଅଛି (କାର୍ଯ୍ୟ-ପ୍ରଥମ)    | `i-have-adhd` | ପ୍ରଥମେ କାର୍ଯ୍ୟ (ଗଦ୍ୟ ପୂର୍ବରୁ କମାଣ୍ଡ/ପାଥ୍/ସ୍ନିପେଟ୍), ସଂଖ୍ୟାଯୁକ୍ତ ଓ ସୀମିତ ପଦକ୍ଷେପ, ଗୋଟିଏ ନିର୍ଦ୍ଦିଷ୍ଟ ପରବର୍ତ୍ତୀ ପଦକ୍ଷେପ, କୌଣସି ପ୍ରସ୍ତାବନା/ପୁନରାବୃତ୍ତି/ସମାପନୀ ନାହିଁ। [ayghri/i-have-adhd](https://github.com/ayghri/i-have-adhd) (MIT) ରୁ ଅନୁକୂଳିତ। | en, pt-BR, es, de, fr, it, ru, zh, ja, id, vi                        |
...
ଡ୍ୟାଶବୋର୍ଡରେ: **Context → Settings → Compression** — ପ୍ରତ୍ୟେକ ଶୈଳୀ ପାଇଁ ଗୋଟିଏ
ଧାଡ଼ି, ଯେଉଁଥିରେ ଏକ ଅନ୍/ଅଫ୍ ଟଗଲ୍ ଏବଂ ଏକ ସ୍ତର ଚୟନକାରୀ ରହିଛି। ପ୍ରୋଗ୍ରାମ୍ ମାଧ୍ୟମରେ,
କମ୍ପ୍ରେସନ୍ କନଫିଗ୍ ଚୟନକୁ ଏପରି ସଂରକ୍ଷଣ କରେ:
...
[EXTENDING_COMPRESSION.md](./EXTENDING_COMPRESSION.md#adding-an-output-style) ଦେଖନ୍ତୁ।
...
ଟୁଲ୍ କଲ୍ ଉପସ୍ଥିତ ଥିଲେ ଟୁଲ୍ ଫଳାଫଳ କମ୍ପ୍ରେସନ୍ **ସର୍ବଦା ସକ୍ରିୟ** ଥାଏ।
କୌଣସି କନଫିଗରେସନ୍ ଆବଶ୍ୟକ ନାହିଁ।

### ଷ୍ଟାକ୍ଡ୍ ପାଇପଲାଇନ୍

ଷ୍ଟାକ୍ଡ୍ ମୋଡ୍ **ଏକାଧିକ ଇଞ୍ଜିନ୍କୁ କ୍ରମାନୁସାରେ** ଚଲାଏ — ସାଧାରଣତଃ ପ୍ରଥମେ RTK
(ଟୁଲ୍ ଆଉଟପୁଟ୍ରେ 60-90% ସଞ୍ଚୟ), ତା’ପରେ କେଭ୍ମ୍ୟାନ୍ (ଅବଶିଷ୍ଟ ପାଠ୍ୟରେ ଅତିରିକ୍ତ
30% ସଞ୍ଚୟ)। ଏହା **ମୋଟ 78-95% ସଞ୍ଚୟ** ହାସଲ କରେ।
...
- [ପରିବେଶ ବିନ୍ୟାସ](../reference/ENVIRONMENT.md) — କମ୍ପ୍ରେସନ୍ ପରିବେଶ ଭେରିଏବଲ୍ଗୁଡ଼ିକ
- [ଆର୍କିଟେକ୍ଚର୍ ଗାଇଡ୍](../architecture/ARCHITECTURE.md) — କମ୍ପ୍ରେସନ୍ ପାଇପ୍ଲାଇନ୍ର ଆଭ୍ୟନ୍ତରୀଣ ବିବରଣୀ
- [ବ୍ୟବହାରକାରୀ ଗାଇଡ୍](../guides/USER_GUIDE.md) — କମ୍ପ୍ରେସନ୍ ସହିତ ଆରମ୍ଭ କରିବା
- [RTK କମ୍ପ୍ରେସନ୍](./RTK_COMPRESSION.md) — RTK ଫିଲ୍ଟର୍ଗୁଡ଼ିକ, ବିଶ୍ୱାସ ମଡେଲ୍, ଯାଞ୍ଚ ଗେଟ୍, ଅପରିବର୍ତ୍ତିତ ଆଉଟ୍ପୁଟ୍ ପୁନରୁଦ୍ଧାର
- [କମ୍ପ୍ରେସନ୍ ଇଞ୍ଜିନ୍ଗୁଡ଼ିକ](./COMPRESSION_ENGINES.md) — Caveman, RTK, ଷ୍ଟାକ୍ଡ, APIs, MCP, ଡ୍ୟାସ୍ବୋର୍ଡ
- [କମ୍ପ୍ରେସନ୍ ନିୟମ ଫର୍ମାଟ୍](./COMPRESSION_RULES_FORMAT.md) — JSON ରୁଲ୍-ପ୍ୟାକ୍ ଫର୍ମାଟ୍
- [କମ୍ପ୍ରେସନ୍ ଭାଷା ପ୍ୟାକ୍ଗୁଡ଼ିକ](./COMPRESSION_LANGUAGE_PACKS.md) — ଭାଷା-ନିର୍ଦ୍ଦିଷ୍ଟ Caveman ନିୟମଗୁଡ଼ିକ
