...
| 移除日期   | 提供者 ID   | 别名   | 域名                                    | 请求方                           | 移除 PR                                                        | 备注                                                                                |
| ---------- | ----------- | ------ | --------------------------------------- | -------------------------------- | -------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| 2026-08-12 | `puter`     | `pu`   | `puter.com`                             | Puter 的所有者（Nariman Jelveh） | [#10210](https://github.com/diegosouzapw/OmniRoute/pull/10210) | 使用 API 密钥的提供者。迁移 `152_remove_puter_provider.sql` 会清理已存储的配置。    |
| 2026-09-02 | `theoldllm` | `tllm` | `theoldllm.com`, `theoldllm.vercel.app` | 服务运营者（通过支持邮箱）       | [#12440](https://github.com/diegosouzapw/OmniRoute/pull/12440) | 无密钥提供者。于 2026-08-30 收到书面请求。已删除专用议题和讨论，并重新命名相关 PR。 |
