...
🌐 **Languages:** 🇺🇸 [English](../../../../reference/FREE_TIERS.md) · 🇪🇹 [am](../../../am/docs/reference/FREE_TIERS.md) · 🇸🇦 [ar](../../../ar/docs/reference/FREE_TIERS.md) · 🇦🇿 [az](../../../az/docs/reference/FREE_TIERS.md) · 🇧🇬 [bg](../../../bg/docs/reference/FREE_TIERS.md) · 🇧🇩 [bn](../../../bn/docs/reference/FREE_TIERS.md) · 🇧🇦 [bs](../../../bs/docs/reference/FREE_TIERS.md) · 🇨🇿 [cs](../../../cs/docs/reference/FREE_TIERS.md) · 🇩🇰 [da](../../../da/docs/reference/FREE_TIERS.md) · 🇩🇪 [de](../../../de/docs/reference/FREE_TIERS.md) · 🇬🇷 [el](../../../el/docs/reference/FREE_TIERS.md) · 🇪🇸 [es](../../../es/docs/reference/FREE_TIERS.md) · 🇪🇪 [et](../../../et/docs/reference/FREE_TIERS.md) · 🇮🇷 [fa](../../../fa/docs/reference/FREE_TIERS.md) · 🇫🇮 [fi](../../../fi/docs/reference/FREE_TIERS.md) · 🇫🇷 [fr](../../../fr/docs/reference/FREE_TIERS.md) · 🇮🇪 [ga](../../../ga/docs/reference/FREE_TIERS.md) · 🇮🇳 [gu](../../../gu/docs/reference/FREE_TIERS.md) · 🇳🇬 [ha](../../../ha/docs/reference/FREE_TIERS.md) · 🇮🇱 [he](../../../he/docs/reference/FREE_TIERS.md) · 🇮🇳 [hi](../../../hi/docs/reference/FREE_TIERS.md) · 🇭🇷 [hr](../../../hr/docs/reference/FREE_TIERS.md) · 🇭🇺 [hu](../../../hu/docs/reference/FREE_TIERS.md) · 🇦🇲 [hy](../../../hy/docs/reference/FREE_TIERS.md) · 🇮🇩 [id](../../../id/docs/reference/FREE_TIERS.md) · 🇳🇬 [ig](../../../ig/docs/reference/FREE_TIERS.md) · 🇮🇹 [it](../../../it/docs/reference/FREE_TIERS.md) · 🇯🇵 [ja](../../../ja/docs/reference/FREE_TIERS.md) · 🇬🇪 [ka](../../../ka/docs/reference/FREE_TIERS.md) · 🇰🇭 [km](../../../km/docs/reference/FREE_TIERS.md) · 🇮🇳 [kn](../../../kn/docs/reference/FREE_TIERS.md) · 🇰🇷 [ko](../../../ko/docs/reference/FREE_TIERS.md) · 🇱🇹 [lt](../../../lt/docs/reference/FREE_TIERS.md) · 🇱🇻 [lv](../../../lv/docs/reference/FREE_TIERS.md) · 🇮🇳 [ml](../../../ml/docs/reference/FREE_TIERS.md) · 🇮🇳 [mr](../../../mr/docs/reference/FREE_TIERS.md) · 🇲🇾 [ms](../../../ms/docs/reference/FREE_TIERS.md) · 🇲🇹 [mt](../../../mt/docs/reference/FREE_TIERS.md) · 🇲🇲 [my](../../../my/docs/reference/FREE_TIERS.md) · 🇳🇵 [ne](../../../ne/docs/reference/FREE_TIERS.md) · 🇳🇱 [nl](../../../nl/docs/reference/FREE_TIERS.md) · 🇳🇴 [no](../../../no/docs/reference/FREE_TIERS.md) · 🇮🇳 [or](../../../or/docs/reference/FREE_TIERS.md) · 🇮🇳 [pa](../../../pa/docs/reference/FREE_TIERS.md) · 🇵🇭 [phi](../../../phi/docs/reference/FREE_TIERS.md) · 🇵🇱 [pl](../../../pl/docs/reference/FREE_TIERS.md) · 🇵🇹 [pt](../../../pt/docs/reference/FREE_TIERS.md) · 🇧🇷 [pt-BR](../../../pt-BR/docs/reference/FREE_TIERS.md) · 🇷🇴 [ro](../../../ro/docs/reference/FREE_TIERS.md) · 🇷🇺 [ru](../../../ru/docs/reference/FREE_TIERS.md) · 🇱🇰 [si](../../../si/docs/reference/FREE_TIERS.md) · 🇸🇰 [sk](../../../sk/docs/reference/FREE_TIERS.md) · 🇸🇮 [sl](../../../sl/docs/reference/FREE_TIERS.md) · 🇷🇸 [sr](../../../sr/docs/reference/FREE_TIERS.md) · 🇸🇪 [sv](../../../sv/docs/reference/FREE_TIERS.md) · 🇰🇪 [sw](../../../sw/docs/reference/FREE_TIERS.md) · 🇮🇳 [ta](../../../ta/docs/reference/FREE_TIERS.md) · 🇮🇳 [te](../../../te/docs/reference/FREE_TIERS.md) · 🇹🇭 [th](../../../th/docs/reference/FREE_TIERS.md) · 🇹🇷 [tr](../../../tr/docs/reference/FREE_TIERS.md) · 🇺🇦 [uk-UA](../../../uk-UA/docs/reference/FREE_TIERS.md) · 🇵🇰 [ur](../../../ur/docs/reference/FREE_TIERS.md) · 🇺🇿 [uz](../../../uz/docs/reference/FREE_TIERS.md) · 🇻🇳 [vi](../../../vi/docs/reference/FREE_TIERS.md) · 🇳🇬 [yo](../../../yo/docs/reference/FREE_TIERS.md) · 🇹🇼 [zh-TW](../../../zh-TW/docs/reference/FREE_TIERS.md)

---

> **面向用户**：想找一份简单指南？请参阅[免费套餐指南](../getting-started/FREE-TIERS-GUIDE.md)，获取免费 AI 的分步操作说明。

> **最后调研日期：** 2026-06-17 — 针对各提供者进行网络调研（官方文档 + 最近 7 天的新闻，由 50 个智能体执行并进行对抗性验证），更新每个免费套餐的配额和服务条款。**于 2026-09-02 进行了部分重新审计**（`gemini`、`ollama-cloud`、`groq`、`nara`、`mistral` — 请参阅下方带日期的说明）。
> **事实来源（目录）：** `open-sse/config/freeModelCatalog.ts`（按模型设置预算，并对共享池去重）。以下 Token 预算数字来自实时网络调研，属于**近似值** — 请参阅[方法与注意事项](#methodology--caveats)。

## TL;DR — OmniRoute 实际聚合了多少免费推理额度？

| 指标                                 | Token / 月 | 含义                                                                                                                                                                                                                                                                  |
| ------------------------------------ | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **有明确文档的周期性额度（稳定值）** | **~1.62B** | 免费层级**额度池**（按模型目录划分），每个共享额度池只计算**一次**。这是 `/api/free-tier/summary` 和仪表板中“免费层级预算”页面背后的实时数据源。**请使用此数字。**                                                                                                    |
| **+ 含注册赠送额度的首月**           | **~2.22B** | 稳定额度 + 一次性注册赠送额度（Z.AI 20M、DeepSeek 5M，……），按账户去重。**仅限首月** — 不会重复发放。                                                                                                                                                                 |
| **+ 永久免费、未公布上限**           | _无法量化_ | `siliconflow`、`glm-cn`（GLM-4-Flash）、`tencent`、`baidu`、`kilo-gateway`、`opencode-zen`、`gemini`、`ollama-cloud` — 确实提供周期性访问，但受速率/并发限制，且**没有可供统计的 Token 上限**。只列出、从不计入总和（按 `RPM×24/7` 计算正是我们拒绝采用的夸大方式）。 |
| **+ 充值解锁增益**                   | **+~24M**  | 一次性向 OpenRouter 充值 **$10**，即可将其免费额度池从每天 50 次请求提高到 1000 次。单独报告，绝不用于抬高稳定额度。                                                                                                                                                  |
| **+ 需要地区身份验证的额度**         | **+~6M**   | `modelscope`（绑定阿里云 + 中国大陆实名认证）。确实属于周期性额度，以 `gatedRecurringTokens` / `gatedProviders` 形式公开，并显示在仪表板上。从不计入标题数字：地区身份验证后可额外获得 ~6M。                                                                          |
| 理论上限（全天候跑满所有速率限制）   | ~10B       | 将每个提供者的速率限制外推到不间断使用后求和。**并非保证额度** — 不要将其作为标题数字。                                                                                                                                                                               |

**如实表述的标题：** _OmniRoute 每月聚合约 **~1.62B 有明确文档的免费 Token**（加上注册赠送额度，首月最高约 ~2.22B），覆盖 35 个免费层级额度池；此外还有一系列永久免费且无明确上限的提供者，而 RTK + Caveman 压缩（可节省 15–95% 的 Token）还能进一步延长这些额度的使用时间。_

> **为什么该数字从之前的 ~1.94B 下调。** 2026-06-17 的更新是一次诚信修正，并非额度减少：`gemini` 现在按额度池去重（此前分别计算每个 Flash 变体，导致数字从 60M 被夸大到 462M）、`cloudflare-ai` 修正为真实的每天 10k Neurons（122M → 30M）、`doubao` 被重新归类为一次性注册赠送额度（而非周期性额度），并移除了已关闭的层级（`chutes`/`phind`/`kluster` 已停止服务）。这些下调被 `llm7`（修正为每天 5M → 每月 150M）和新增的免费提供者（Kilo、OpenCode Zen、Z.AI GLM-Flash）部分抵消。
>
> **在 v3.8.42 中进一步修正为 ~1.37B：** `longcat` 的免费预览结束后，从每月 150M 的周期性额度重新归类为一次性 10M 注册赠送额度。遵循同一诚信原则 — 没有任何提供者因失误而被移除。
>
> **在 Felo Web 于 2026-08-26 停用后更新：** 在其源自 GPL 的来源/许可问题仍处于 HOLD 状态期间，Felo Web 不计入统计；当时数据源报告了 38 个额度池键。额度池数量是实时的，并由 CI 把关（如果上述数字与 `computeFreeModelTotals()` 产生偏差，`check:docs-counts` 将导致构建失败）。
>
> **已于 2026-09-02 根据提供者自己的页面重新审核**（来源：`open-sse/config/freeModelCatalog.data.ts` 中每个重新审核条目旁的 `// evidence:` 注释）：`gemini` 和 `ollama-cloud` 不再公布 Token 数量（Google 于 2025-12-23 移除了按模型划分的免费额度表；Ollama 的 Free 计划只注明“starter usage credits”），因此现在将它们列为**无明确上限**且从不计入总和（−80M）；`groq` 有五个**按模型划分**的 200K-TPD 上限（每个 6M，合计 +15M），并移除了三个已停用的 ID；`nara` 是一个每天 7M 的共享额度池（+60M，合计 210M）。`mistral` 的 1B 额度仅在账户控制台中可见 — 请参阅“方法论”下的_证据分类_。
>
> **已于 2026-09-03 修正（#11773）：** `cerebras` 从每月 30M 的周期性额度（旧版无需银行卡、每天 1M Token 的试用）重新归类为一次性 $5 注册赠送额度，且需要提供付款方式。遵循与 LongCat 相同的诚信原则。
>
> **另加 xKiro（2026-09-03）：** 新增的 `xkiro-free` 额度池（每月 150M）使周期性额度池键增至 35 个。在其源自 GPL 的来源/许可问题仍处于 HOLD 状态期间，Felo Web 仍不计入统计。数据源现在报告 **35 个周期性额度池键**和**约 1.62B 的稳定额度** — 这是由 CI 把关的实时数字（如果它与 `computeFreeModelTotals()` 产生偏差，`check:docs-counts` 将导致构建失败）。

有明确文档的最大贡献者：`mistral` 1.00B、`nara` 210M、`llm7` 150M、`xkiro` 150M、`groq` 30M（五个按模型划分的上限）、`cloudflare-ai` 30M、`api-airforce` 24M。（`longcat` 不计入其中 — 其 10M 的 LongCat-2.0 额度是需要 KYC 的一次性注册赠送额度，而非周期性月度预算。）

> ⚠️ 理论上限（约 100 亿）因仅设速率限制且**未公布令牌上限**的提供者（`tencent`、`siliconflow`、`nvidia`、`baidu`、`glm-cn`、`sparkdesk`）而被夸大；其数值按 `RPM/TPM × 24/7 × 30d` 计算——这是任何单一账户都无法持续达到的理论最大值。因此，这些提供者**未计入**可信数值（而是列在“永久免费、无上限”一行中）。竞争对手宣称数十亿额度之所以不可靠，也是出于同样的夸大计算。
...
- **Gemini**——`2.0 Flash` / `2.0 Flash-Lite` 已于 2026-06-01 停止服务，`2.5 Pro` 也已退出免费层（2026-04）；现在的免费层**仅包含 Flash 系列**（2.5/3/3.1/3.5 Flash + Gemma）。目录现在会将 Flash 系列**合并统计**（此前因分别计算每个变体而导致数据虚高：462M → 60M）。
...
- **新增的如实分层**（参见方法论）：一个_永久免费但无明确额度上限_类别（真正可周期性使用，但没有可统计的 token 上限），以及一个_存款解锁加成_类别（OpenRouter $10 → 每月增加 24M）；二者均**单独**展示，因此绝不会抬高概要数据。
...
OmniRoute 通过两种机制来回答“它是否免费？”，这两种机制会有意读取
不同的数据源：
...
只要数据源可用，统计结果便可随时改进。判定则始终依据
发布产物，因此浏览器和服务器给出的答案完全一致，
可以离线复现，也能在不依赖数据库的情况下进行测试。如果允许浏览器
预览读取一个数据源，而服务器导入读取另一个数据源，就会导致
预览结果与点击后的实际行为不一致——因此有意保留了这种
机制分离。

## 方法论与注意事项

- 这些数字是根据截至 **2026-06-17** 各提供者记录在案的免费套餐限制，通过网络调研得出的**上限估算值**。免费套餐经常变化——在依赖某个数字之前，请重新核实。
...
- **永久免费，但没有公布 token 上限**（`siliconflow`、`glm-cn`、`tencent`、`baidu`、`kilo-gateway`、`opencode-zen`、`gemini`、`ollama-cloud`）：这些确实是持续提供的免费访问，但受速率/并发限制。我们将其归类为 `recurring-uncapped`，并且**绝不将它们计入总和**——用 `RPM × 24/7 × 30d` 计算会产生一个脱离现实的上限（我们拒绝这种虚增方式）。将它们列出是为了让你知道它们确实存在。
...
- **证据类别。** 规则如下：目录中的数字会在条目旁的 `// evidence:` 注释中注明来源——`public-page`（任何人都可以访问的提供者页面）、`api-public`（提供者无需身份验证即可访问的端点，例如 NaraRouter 位于 router.bynara.id 的公开套餐端点），或 `console-verified <date> por <who>`（该数字仅在账户控制台中可见；注释会记录查看者及查看时间，并附上说明该上限确实存在的公开页面）。当前状态：在 2026-09-02 重新审核的五个区块都带有此信息（`gemini`、`groq`、`mistral`、`ollama-cloud`、`nara`）；早于 2026-09-02 重新审核的条目会沿用此前的研究结果，直至它们被修改；任何**新增或变更**的数字如果没有证据注释，都属于缺陷。目前只有 `mistral` 经过控制台验证。
...
- **每日上限会被换算，速率限制不会。** 有明确文档说明的每日 token 上限会按 `× 30` 换算；有明确文档说明的每日请求上限会按 `RPD × ~800 tokens × 30` 换算；如果提供者只公布每分钟请求数，则**不会**计算月度额度，并会将其列为_无上限_，绝不计入总和。将速率限制按 24/7 全天候运行来相乘，正是我们拒绝采用的虚增方式。
...
> 根据各模型目录（`open-sse/config/freeModelCatalog.ts`）重新生成，并按池去重。按每月稳定持续提供的 token 数排序。`uncapped*` = 永久免费，但未公布 token 上限（受速率/并发限制）——可实际使用，**但未**计入标题汇总。`—` = 仅限赠金 / 无需密钥 / 无法以 token 量化。
...
- **`longcat`** — 公开预览版/测试版已结束，Flash 模型也已停用；目前仅剩正式发布的 `LongCat-2.0`。免费层是在完成账户注册和**KYC 验证**后解锁的**一次性 10M-token 赠额**——它**不会**按天或按月重置。用完赠额后按使用量付费。
...
- **`phind`** — Phind 已于 2026 年 1 月 16 日停止运营。该提供者现已从目录中**完全移除**（包括注册表、执行器，以及 Web Cookie 和 API 密钥目录条目）— 与失效服务移除的先例一致（#5246 Gemini CLI）。
...
- **`puter`** — 应 Puter 所有者 Nariman Jelveh 的要求，已从目录中**完全移除**（包括注册表、执行器、免费模型目录和 API 密钥条目）— 请参见上文的失效服务移除先例（`phind`）。
