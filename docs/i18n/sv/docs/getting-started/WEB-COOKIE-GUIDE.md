...
Även om dessa cookies ser korrekta ut kan de vara:
...
Använd i stället cookies från en lyckad begäran:

```
DevTools
→ Network
→ Uppdatera sidan
→ Öppna en chatt- eller konversationsbegäran
→ Request Headers
→ Cookie
```
...
3. Öppna fliken **Network**.
4. Uppdatera sidan.
5. Öppna en autentiserad chatt- eller konversationsbegäran.
...
- Autentisering med din befintliga webbläsarsession
- Åtkomst till modeller som är tillgängliga via ditt konto
- Strömning av chattsvar
...
- Agentbaserade IDE-arbetsflöden
- Funktioner som endast är tillgängliga via API
