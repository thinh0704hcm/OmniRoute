...
## Kopeerige aktiivsest päringust
...
Seadistamisprotsess on enamiku veebiküpsiste pakkujate puhul sama.
...
| Microsoft 365 Copilot (BizChat) | WS-i access_token + chathubPath | `docs/providers/COPILOT-M365.md` |
...
Täieliku pakkujapõhise juhendi leiate siit:
