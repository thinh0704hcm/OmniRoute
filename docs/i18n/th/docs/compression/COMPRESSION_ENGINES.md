...
OmniRoute จะไม่มอบหมายการตัดสินใจนี้ให้ส่วนอื่น: อะแดปเตอร์จะตรึงเกตของโมเดลไว้ที่ขอบเขต
ที่จำกัดที่สุดของแพ็กเกจ ดังนั้นการตั้งค่าสภาพแวดล้อมของโฮสต์จึงทำได้เพียงจำกัดรายการที่อนุญาตให้แคบลง
และไม่สามารถขยายให้เกินกว่าผลการวัดของ OmniRoute ได้
