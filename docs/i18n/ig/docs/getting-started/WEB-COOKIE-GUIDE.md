...
DevTools
→ Network
→ Mee ka ibe ahụ dị ọhụrụ
→ Mepee arịrịọ nkata ma ọ bụ mkparịta ụka
→ Request Headers
→ Cookie
```
