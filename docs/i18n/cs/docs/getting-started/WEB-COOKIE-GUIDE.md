...
## Nekopírujte z úložiště souborů cookie
...
| Gemini Web                      | _(ověřit)_                      |                                  |
| Copilot Web                     | _(ověřit)_                      | `docs/providers/COPILOT-M365.md` |
...
Úplný postup pro konkrétního poskytovatele naleznete zde:
