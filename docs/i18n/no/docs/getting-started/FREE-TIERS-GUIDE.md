...
## Slik kobler du til gratisleverandører
...
Koble til flere leverandører med vilkår og personvernmodeller som passer til bruksområdet ditt.
...
## Slik gjør OmniRoute gratiskvoter bedre

### 1. Automatisk reservebytte

Hvis én gratisleverandør er opptatt eller nede, prøver OmniRoute automatisk den neste. Du trenger ikke å gjøre noe.

### 2. Smart ruting

OmniRoute velger den **beste gratisleverandøren** for hver forespørsel basert på:

- Hastighet — Hvilken leverandør er raskest akkurat nå?
- Kvalitet — Hvilken leverandør er best egnet for denne oppgaven?
- Kapasitet — Hvilken leverandør har gjenværende kvote?

### 3. Tokenbesparelser

OmniRoutes komprimeringsprosess kan redusere antall kvalifiserte tokener i ledetekster og verktøyutdata. De
faktiske besparelsene avhenger av innholdet, valgte motorer, leverandørens beregningsmetode og innstillinger
for nøyaktighet. Komprimering multipliserer ikke hver leverandørkvote med en fast faktor.

### 4. Støtte for flere kontoer

Hvis leverandørvilkårene tillater flere kontoer eller påloggingsopplysninger, kan OmniRoute behandle hver
tilkobling som en separat rutingskandidat. Ikke opprett ekstra kontoer for å omgå en leverandørs
kvote- eller tilgangsregler.
...
Katalogen registrerer vilkår publisert av leverandørene og undersøkelser utført av prosjektet, men tilbud kan endres.
Kontroller leverandørens gjeldende priser, kvoter, personvernerklæring og kvalifikasjonskrav før bruk.

### «Vil gratiskvoten bli brukt opp?»

Alle leverandører kan begrense forespørselsfrekvensen, endre modeller, suspendere tilgang eller bli utilgjengelige. Flere
tilkoblinger gir bedre dekning ved reservebytte, men garanterer ikke at en gratisrute er tilgjengelig.

### «Kan jeg bruke gratisleverandører i produksjon?»

Bare hvis leverandørens SLA, databehandling, begrensninger og vilkår oppfyller
produksjonskravene dine. Kritiske arbeidsbelastninger bør ha overvåkede, kontraktsmessig egnede reserveløsninger.

### «Hva er haken?»

Ulempene kan omfatte strenge begrensninger, ventelister, KYC, kredittkortverifisering, trening på
promptene, svakere personvern, ingen SLA, hyppige modellendringer, geografiske begrensninger, betaling for overforbruk eller
risiko knyttet til kontoretningslinjer. OmniRoute viser tilgjengelige metadata; du velger hva som skal aktiveres.

### «Hvordan får jeg en større gratiskvote?»

1. Koble til flere gratisleverandører
2. Aktiver egnede komprimeringsmotorer og mål besparelsene for arbeidsbelastningen din
3. Bruk `auto/cheap` for å prioritere gratis/billige leverandører
4. Legg til flere tillatte leverandører eller legitimasjoner uten å bryte leverandørvilkårene

### «Har gratisleverandører dårligere kvalitet?»

Ikke nødvendigvis. Noen leverandører tilbyr de samme modellfamiliene som er tilgjengelige gjennom betalte
ruter, men begrensninger, ventetid, personvern, pålitelighet og modellversjoner kan variere. Bruk
rangeringssiden for gratisleverandører som en kvalitetsindikator, og kontroller hvilken modell som faktisk leveres.
...
- **[Leverandørveiledning](./PROVIDERS-GUIDE.md)** — Koble til flere leverandører
- **[Feilsøking](../guides/TROUBLESHOOTING.md)** — Løs vanlige problemer
- **[Referanse for gratisnivåer](../reference/FREE_TIERS.md)** — Fullstendig liste over gratisnivåer
